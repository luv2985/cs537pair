...
80102088:	68 a2 7a 10 80       	push   $0x80107aa2
...
80103046:	e8 15 3a 00 00       	call   80106a60 <switchkvm>
  seginit();
8010304b:	e8 00 38 00 00       	call   80106850 <seginit>
  lapicinit();
...
80103090:	e8 bb 37 00 00       	call   80106850 <seginit>
  picinit();       // disable pic
...
801038d6:	68 a0 78 10 80       	push   $0x801078a0
...
80103a3f:	68 d0 78 10 80       	push   $0x801078d0
80103a44:	50                   	push   %eax
80103a45:	e8 d6 0d 00 00       	call   80104820 <safestrcpy>
  p->cwd = namei("/");
80103a4a:	c7 04 24 d9 78 10 80 	movl   $0x801078d9,(%esp)
...
80103a83:	68 b7 78 10 80       	push   $0x801078b7
...
80103e9d:	68 28 79 10 80       	push   $0x80107928
80103ea2:	e8 d9 c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103ea7:	83 ec 0c             	sub    $0xc,%esp
80103eaa:	68 1b 79 10 80       	push   $0x8010791b
...
80103fe0:	68 34 79 10 80       	push   $0x80107934
...
801040e9:	68 3a 79 10 80       	push   $0x8010793a
801040ee:	e8 8d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
801040f3:	83 ec 0c             	sub    $0xc,%esp
801040f6:	68 34 79 10 80       	push   $0x80107934
...
801041fb:	68 bb 7c 10 80       	push   $0x80107cbb
...
8010421c:	74 ea                	je     80104208 <procdump+0x28>
      state = "???";
8010421e:	ba 4b 79 10 80       	mov    $0x8010794b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104223:	83 f8 05             	cmp    $0x5,%eax
80104226:	77 11                	ja     80104239 <procdump+0x59>
80104228:	8b 14 85 ac 79 10 80 	mov    -0x7fef8654(,%eax,4),%edx
      state = "???";
8010422f:	b8 4b 79 10 80       	mov    $0x8010794b,%eax
...
8010423e:	68 4f 79 10 80       	push   $0x8010794f
...
8010427d:	68 a1 73 10 80       	push   $0x801073a1
...
801044e5:	68 cf 79 10 80       	push   $0x801079cf
801044ea:	e8 91 be ff ff       	call   80100380 <panic>
    panic("popcli");
801044ef:	83 ec 0c             	sub    $0xc,%esp
801044f2:	68 e6 79 10 80       	push   $0x801079e6
...
8010455b:	68 ed 79 10 80       	push   $0x801079ed
...
80104650:	68 f5 79 10 80       	push   $0x801079f5
...
80104a60 <syscall>:
[SYS_wmap]	  sys_wmap, // Vincent's edit: define function pointer
};
...
80104a7c:	8b 14 85 20 7a 10 80 	mov    -0x7fef85e0(,%eax,4),%edx
...
80104aa8:	68 fd 79 10 80       	push   $0x801079fd
...
80104c04:	68 98 7a 10 80       	push   $0x80107a98
...
80104c1c:	68 97 7a 10 80       	push   $0x80107a97
...
80104c31:	68 8b 7a 10 80       	push   $0x80107a8b
...
80104c4f:	68 9a 7a 10 80       	push   $0x80107a9a
80104c54:	e8 27 b7 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104c59:	83 ec 0c             	sub    $0xc,%esp
80104c5c:	68 7c 7a 10 80       	push   $0x80107a7c
...
8010505d:	58                   	pop    %eax
8010505e:	5a                   	pop    %edx
8010505f:	68 98 7a 10 80       	push   $0x80107a98
...
80105078:	68 97 7a 10 80       	push   $0x80107a97
...
801058ae:	00 00 ef 
  initlock(&tickslock, "time");
801058b1:	68 dd 7a 10 80       	push   $0x80107add
...
80105934:	ff 24 85 84 7b 10 80 	jmp    *-0x7fef847c(,%eax,4)
...
80105a15:	68 40 7b 10 80       	push   $0x80107b40
...
80105a67:	68 e8 7a 10 80       	push   $0x80107ae8
...
80105b83:	68 0c 7b 10 80       	push   $0x80107b0c
80105b88:	e8 13 ab ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105b8d:	83 c4 14             	add    $0x14,%esp
80105b90:	68 e2 7a 10 80       	push   $0x80107ae2
...
80105c3c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105c3f:	bf 04 7c 10 80       	mov    $0x80107c04,%edi
...
8010683f:	68 c6 75 10 80       	push   $0x801075c6
...
80106853:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106856:	e8 f5 d0 ff ff       	call   80103950 <cpuid>
  pd[0] = size-1;
...
8010686a:	c7 80 18 18 11 80 ff 	movl   $0xffff,-0x7feee7e8(%eax)
80106871:	ff 00 00 
80106874:	c7 80 1c 18 11 80 00 	movl   $0xcf9a00,-0x7feee7e4(%eax)
8010687b:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010687e:	c7 80 20 18 11 80 ff 	movl   $0xffff,-0x7feee7e0(%eax)
80106885:	ff 00 00 
80106888:	c7 80 24 18 11 80 00 	movl   $0xcf9200,-0x7feee7dc(%eax)
8010688f:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106892:	c7 80 28 18 11 80 ff 	movl   $0xffff,-0x7feee7d8(%eax)
80106899:	ff 00 00 
8010689c:	c7 80 2c 18 11 80 00 	movl   $0xcffa00,-0x7feee7d4(%eax)
801068a3:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801068a6:	c7 80 30 18 11 80 ff 	movl   $0xffff,-0x7feee7d0(%eax)
801068ad:	ff 00 00 
801068b0:	c7 80 34 18 11 80 00 	movl   $0xcff200,-0x7feee7cc(%eax)
801068b7:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
801068ba:	05 10 18 11 80       	add    $0x80111810,%eax
  pd[1] = (uint)p;
...
801068e9:	8b 7d 0c             	mov    0xc(%ebp),%edi
  pde = &pgdir[PDX(va)];
801068ec:	8b 55 08             	mov    0x8(%ebp),%edx
801068ef:	89 fe                	mov    %edi,%esi
801068f1:	c1 ee 16             	shr    $0x16,%esi
801068f4:	8d 34 b2             	lea    (%edx,%esi,4),%esi
  if(*pde & PTE_P){
801068f7:	8b 1e                	mov    (%esi),%ebx
801068f9:	f6 c3 01             	test   $0x1,%bl
801068fc:	74 22                	je     80106920 <walkpgdir+0x40>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
801068fe:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80106904:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
  return &pgtab[PTX(va)];
8010690a:	89 f8                	mov    %edi,%eax
}
8010690c:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return &pgtab[PTX(va)];
8010690f:	c1 e8 0a             	shr    $0xa,%eax
80106912:	25 fc 0f 00 00       	and    $0xffc,%eax
80106917:	01 d8                	add    %ebx,%eax
}
80106919:	5b                   	pop    %ebx
8010691a:	5e                   	pop    %esi
8010691b:	5f                   	pop    %edi
...
80106925:	74 31                	je     80106958 <walkpgdir+0x78>
80106927:	e8 54 bd ff ff       	call   80102680 <kalloc>
8010692c:	89 c3                	mov    %eax,%ebx
8010692e:	85 c0                	test   %eax,%eax
80106930:	74 26                	je     80106958 <walkpgdir+0x78>
    memset(pgtab, 0, PGSIZE);
80106932:	83 ec 04             	sub    $0x4,%esp
80106935:	68 00 10 00 00       	push   $0x1000
8010693a:	6a 00                	push   $0x0
8010693c:	50                   	push   %eax
8010693d:	e8 1e dd ff ff       	call   80104660 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106942:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106948:	83 c4 10             	add    $0x10,%esp
8010694b:	83 c8 07             	or     $0x7,%eax
8010694e:	89 06                	mov    %eax,(%esi)
80106950:	eb b8                	jmp    8010690a <walkpgdir+0x2a>
...
8010697f:	89 c3                	mov    %eax,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106981:	8d 44 10 ff          	lea    -0x1(%eax,%edx,1),%eax
80106985:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  a = (char*)PGROUNDDOWN((uint)va);
8010698a:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106990:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106993:	8b 45 14             	mov    0x14(%ebp),%eax
80106996:	29 d8                	sub    %ebx,%eax
80106998:	89 45 e4             	mov    %eax,-0x1c(%ebp)
8010699b:	eb 3a                	jmp    801069d7 <mappages+0x67>
...
801069be:	0f 85 86 00 00 00    	jne    80106a4a <mappages+0xda>
    *pte = pa | perm | PTE_P;
801069c4:	0b 75 18             	or     0x18(%ebp),%esi
801069c7:	83 ce 01             	or     $0x1,%esi
801069ca:	89 30                	mov    %esi,(%eax)
    if(a == last)
801069cc:	3b 5d e0             	cmp    -0x20(%ebp),%ebx
...
801069d7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  pde = &pgdir[PDX(va)];
801069da:	8b 4d 08             	mov    0x8(%ebp),%ecx
...
801069fa:	89 45 dc             	mov    %eax,-0x24(%ebp)
...
80106a05:	e8 56 dc ff ff       	call   80104660 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106a0a:	8b 55 dc             	mov    -0x24(%ebp),%edx
  return &pgtab[PTX(va)];
...
80106a4d:	68 0c 7c 10 80       	push   $0x80107c0c
...
80106b98:	77 50                	ja     80106bea <inituvm+0x6a>
80106b9a:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  mem = kalloc();
...
80106bb7:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106bbd:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
80106bc4:	50                   	push   %eax
80106bc5:	68 00 10 00 00       	push   $0x1000
80106bca:	6a 00                	push   $0x0
80106bcc:	52                   	push   %edx
80106bcd:	e8 9e fd ff ff       	call   80106970 <mappages>
  memmove(mem, init, sz);
80106bd2:	89 75 10             	mov    %esi,0x10(%ebp)
80106bd5:	83 c4 20             	add    $0x20,%esp
80106bd8:	89 7d 0c             	mov    %edi,0xc(%ebp)
80106bdb:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
...
80106be4:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106be5:	e9 16 db ff ff       	jmp    80104700 <memmove>
    panic("inituvm: more than a page");
80106bea:	83 ec 0c             	sub    $0xc,%esp
80106bed:	68 51 7c 10 80       	push   $0x80107c51
...
80106c50:	68 6b 7c 10 80       	push   $0x80107c6b
...
80106cd8:	68 0c 7d 10 80       	push   $0x80107d0c
...
80106d10:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
80106d16:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
...
80106d2b:	eb 43                	jmp    80106d70 <allocuvm+0x80>
...
80106d46:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
80106d4d:	50                   	push   %eax
80106d4e:	68 00 10 00 00       	push   $0x1000
80106d53:	56                   	push   %esi
80106d54:	57                   	push   %edi
80106d55:	e8 16 fc ff ff       	call   80106970 <mappages>
80106d5a:	83 c4 20             	add    $0x20,%esp
80106d5d:	85 c0                	test   %eax,%eax
80106d5f:	78 6f                	js     80106dd0 <allocuvm+0xe0>
  for(; a < newsz; a += PGSIZE){
80106d61:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106d67:	39 75 10             	cmp    %esi,0x10(%ebp)
80106d6a:	0f 86 a0 00 00 00    	jbe    80106e10 <allocuvm+0x120>
    mem = kalloc();
80106d70:	e8 0b b9 ff ff       	call   80102680 <kalloc>
80106d75:	89 c3                	mov    %eax,%ebx
    if(mem == 0){
80106d77:	85 c0                	test   %eax,%eax
80106d79:	75 b5                	jne    80106d30 <allocuvm+0x40>
      cprintf("allocuvm out of memory\n");
80106d7b:	83 ec 0c             	sub    $0xc,%esp
80106d7e:	68 89 7c 10 80       	push   $0x80107c89
80106d83:	e8 18 99 ff ff       	call   801006a0 <cprintf>
  if(newsz >= oldsz)
80106d88:	8b 45 0c             	mov    0xc(%ebp),%eax
80106d8b:	83 c4 10             	add    $0x10,%esp
80106d8e:	39 45 10             	cmp    %eax,0x10(%ebp)
80106d91:	74 2d                	je     80106dc0 <allocuvm+0xd0>
80106d93:	8b 55 10             	mov    0x10(%ebp),%edx
80106d96:	89 c1                	mov    %eax,%ecx
80106d98:	8b 45 08             	mov    0x8(%ebp),%eax
      return 0;
80106d9b:	31 ff                	xor    %edi,%edi
80106d9d:	e8 fe f9 ff ff       	call   801067a0 <deallocuvm.part.0>
}
...
80106dd3:	68 a1 7c 10 80       	push   $0x80107ca1
80106dd8:	e8 c3 98 ff ff       	call   801006a0 <cprintf>
  if(newsz >= oldsz)
...
80106df0:	e8 ab f9 ff ff       	call   801067a0 <deallocuvm.part.0>
      kfree(mem);
...
80106dfb:	e8 c0 b6 ff ff       	call   801024c0 <kfree>
      return 0;
...
80106e30:	5d                   	pop    %ebp
80106e31:	e9 6a f9 ff ff       	jmp    801067a0 <deallocuvm.part.0>
...
80106e6b:	e8 30 f9 ff ff       	call   801067a0 <deallocuvm.part.0>
...
80106ebc:	68 bd 7c 10 80       	push   $0x80107cbd
...
80106efb:	8b 53 08             	mov    0x8(%ebx),%edx
80106efe:	83 ec 0c             	sub    $0xc,%esp
80106f01:	ff 73 0c             	push   0xc(%ebx)
80106f04:	29 c2                	sub    %eax,%edx
80106f06:	50                   	push   %eax
80106f07:	52                   	push   %edx
80106f08:	ff 33                	push   (%ebx)
80106f0a:	56                   	push   %esi
80106f0b:	e8 60 fa ff ff       	call   80106970 <mappages>
80106f10:	83 c4 20             	add    $0x20,%esp
...
80106f8c:	68 ce 7c 10 80       	push   $0x80107cce
...
80106fd3:	0f 84 c0 00 00 00    	je     80107099 <copyuvm+0xd9>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106fd9:	8b 55 0c             	mov    0xc(%ebp),%edx
80106fdc:	85 d2                	test   %edx,%edx
80106fde:	0f 84 b5 00 00 00    	je     80107099 <copyuvm+0xd9>
...
80107002:	68 d8 7c 10 80       	push   $0x80107cd8
...
80107029:	74 d4                	je     80106fff <copyuvm+0x3f>
    if(!(*pte & PTE_P))
8010702b:	8b 38                	mov    (%eax),%edi
8010702d:	f7 c7 01 00 00 00    	test   $0x1,%edi
80107033:	0f 84 9b 00 00 00    	je     801070d4 <copyuvm+0x114>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80107039:	89 fb                	mov    %edi,%ebx
    flags = PTE_FLAGS(*pte);
8010703b:	81 e7 ff 0f 00 00    	and    $0xfff,%edi
80107041:	89 7d e4             	mov    %edi,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80107044:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
    if((mem = kalloc()) == 0)
8010704a:	e8 31 b6 ff ff       	call   80102680 <kalloc>
8010704f:	89 c7                	mov    %eax,%edi
80107051:	85 c0                	test   %eax,%eax
80107053:	74 5f                	je     801070b4 <copyuvm+0xf4>
      goto bad;
    memmove(mem, (char*)P2V(pa), PGSIZE);
80107055:	83 ec 04             	sub    $0x4,%esp
80107058:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
8010705e:	68 00 10 00 00       	push   $0x1000
80107063:	53                   	push   %ebx
80107064:	50                   	push   %eax
80107065:	e8 96 d6 ff ff       	call   80104700 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
8010706a:	58                   	pop    %eax
8010706b:	8d 87 00 00 00 80    	lea    -0x80000000(%edi),%eax
80107071:	ff 75 e4             	push   -0x1c(%ebp)
80107074:	50                   	push   %eax
80107075:	68 00 10 00 00       	push   $0x1000
8010707a:	56                   	push   %esi
8010707b:	ff 75 e0             	push   -0x20(%ebp)
8010707e:	e8 ed f8 ff ff       	call   80106970 <mappages>
80107083:	83 c4 20             	add    $0x20,%esp
80107086:	85 c0                	test   %eax,%eax
80107088:	78 1e                	js     801070a8 <copyuvm+0xe8>
  for(i = 0; i < sz; i += PGSIZE){
8010708a:	81 c6 00 10 00 00    	add    $0x1000,%esi
80107090:	39 75 0c             	cmp    %esi,0xc(%ebp)
80107093:	0f 87 57 ff ff ff    	ja     80106ff0 <copyuvm+0x30>
  return d;
...
801070d7:	68 f2 7c 10 80       	push   $0x80107cf2
...
80107226:	e8 45 c7 ff ff       	call   80103970 <myproc>
8010722b:	83 ec 04             	sub    $0x4,%esp
8010722e:	6a 00                	push   $0x0
80107230:	ff 75 08             	push   0x8(%ebp)
80107233:	ff 70 04             	push   0x4(%eax)
80107236:	e8 a5 f6 ff ff       	call   801068e0 <walkpgdir>

    if (pte != 0 && (*pte & PTE_P) != 0) {
8010723b:	83 c4 10             	add    $0x10,%esp
8010723e:	85 c0                	test   %eax,%eax
80107240:	74 0a                	je     8010724c <check_valid+0x2c>
...
80107244:	c9                   	leave  
    if (pte != 0 && (*pte & PTE_P) != 0) {
80107245:	83 e0 01             	and    $0x1,%eax
80107248:	83 e8 01             	sub    $0x1,%eax
}
8010724b:	c3                   	ret    
8010724c:	c9                   	leave  
        return FAILED;
...
80107252:	c3                   	ret    
80107253:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010725a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

80107260 <find_nu_addr>:
...
80107264:	83 ec 04             	sub    $0x4,%esp
    char* mem = kalloc();
80107267:	e8 14 b4 ff ff       	call   80102680 <kalloc>
8010726c:	89 c3                	mov    %eax,%ebx
    mappages(myproc()->pgdir, (void*) va, PGSIZE, V2P(mem), PTE_W | PTE_U);
8010726e:	e8 fd c6 ff ff       	call   80103970 <myproc>
80107273:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
80107279:	83 ec 0c             	sub    $0xc,%esp
8010727c:	6a 06                	push   $0x6
8010727e:	53                   	push   %ebx
8010727f:	68 00 10 00 00       	push   $0x1000
80107284:	ff 75 08             	push   0x8(%ebp)
80107287:	ff 70 04             	push   0x4(%eax)
8010728a:	e8 e1 f6 ff ff       	call   80106970 <mappages>
    return 0;
}
8010728f:	8b 5d fc             	mov    -0x4(%ebp),%ebx
...
801072ac:	8b 45 10             	mov    0x10(%ebp),%eax
    
	/* CHECK FLAGS */

	// check length
	if(length <= 0) {
801072af:	85 f6                	test   %esi,%esi
801072b1:	0f 8e 89 00 00 00    	jle    80107340 <sys_wmap+0xa0>
        //printf("u dumb\n");
        return FAILED;
    }
...
801072b7:	89 c2                	mov    %eax,%edx
801072b9:	83 e2 03             	and    $0x3,%edx
801072bc:	83 fa 03             	cmp    $0x3,%edx
801072bf:	74 7f                	je     80107340 <sys_wmap+0xa0>
    // get process
    //struct proc *curproc = myproc();
    uint va;
	...
	// MAP_FIXED flag
    if (flags & MAP_FIXED) {
801072c1:	a8 08                	test   $0x8,%al
801072c3:	74 7b                	je     80107340 <sys_wmap+0xa0>
        if (addr < USERBOUNDARY || addr >= KERNBASE || addr % PGSIZE != 0) {
801072c5:	8b 45 08             	mov    0x8(%ebp),%eax
801072c8:	2d 00 00 00 60       	sub    $0x60000000,%eax
801072cd:	3d ff ff ff 1f       	cmp    $0x1fffffff,%eax
801072d2:	77 6c                	ja     80107340 <sys_wmap+0xa0>
801072d4:	8b 7d 08             	mov    0x8(%ebp),%edi
801072d7:	81 e7 ff 0f 00 00    	and    $0xfff,%edi
801072dd:	75 61                	jne    80107340 <sys_wmap+0xa0>
    pte_t *pte = walkpgdir(myproc()->pgdir, (void *)addr, 0);
801072df:	e8 8c c6 ff ff       	call   80103970 <myproc>
801072e4:	83 ec 04             	sub    $0x4,%esp
801072e7:	6a 00                	push   $0x0
801072e9:	ff 75 08             	push   0x8(%ebp)
801072ec:	ff 70 04             	push   0x4(%eax)
801072ef:	e8 ec f5 ff ff       	call   801068e0 <walkpgdir>
    if (pte != 0 && (*pte & PTE_P) != 0) {
801072f4:	83 c4 10             	add    $0x10,%esp
801072f7:	85 c0                	test   %eax,%eax
801072f9:	74 45                	je     80107340 <sys_wmap+0xa0>
801072fb:	f6 00 01             	testb  $0x1,(%eax)
801072fe:	74 40                	je     80107340 <sys_wmap+0xa0>
    char* mem = kalloc();
80107300:	e8 7b b3 ff ff       	call   80102680 <kalloc>
	...
	int leftover = length;
	while (leftover > 0) {
80107305:	81 ee 00 10 00 00    	sub    $0x1000,%esi
    char* mem = kalloc();
8010730b:	89 c3                	mov    %eax,%ebx
    mappages(myproc()->pgdir, (void*) va, PGSIZE, V2P(mem), PTE_W | PTE_U);
8010730d:	e8 5e c6 ff ff       	call   80103970 <myproc>
80107312:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
80107318:	83 ec 0c             	sub    $0xc,%esp
8010731b:	6a 06                	push   $0x6
8010731d:	53                   	push   %ebx
8010731e:	68 00 10 00 00       	push   $0x1000
80107323:	ff 75 08             	push   0x8(%ebp)
80107326:	ff 70 04             	push   0x4(%eax)
80107329:	e8 42 f6 ff ff       	call   80106970 <mappages>
	while (leftover > 0) {
8010732e:	83 c4 20             	add    $0x20,%esp
80107331:	85 f6                	test   %esi,%esi
80107333:	7f cb                	jg     80107300 <sys_wmap+0x60>
	}
...
80107340:	8d 65 f4             	lea    -0xc(%ebp),%esp
        return FAILED;
80107343:	bf ff ff ff ff       	mov    $0xffffffff,%edi
}
80107348:	5b                   	pop    %ebx
80107349:	89 f8                	mov    %edi,%eax
8010734b:	5e                   	pop    %esi
8010734c:	5f                   	pop    %edi
8010734d:	5d                   	pop    %ebp
8010734e:	c3                   	ret    

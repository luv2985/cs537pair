...
801003b0:	e8 eb 02 00 00       	call   801006a0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 e7 81 10 80 	movl   $0x801081e7,(%esp)
...
80102088:	68 32 7f 10 80       	push   $0x80107f32
...
801024d2:	81 fb d0 a5 11 80    	cmp    $0x8011a5d0,%ebx
...
80103077:	68 d0 a5 11 80       	push   $0x8011a5d0
...
801037cf:	90                   	nop
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801037d0:	81 c3 80 01 00 00    	add    $0x180,%ebx
801037d6:	81 fb 54 8d 11 80    	cmp    $0x80118d54,%ebx
...
80103827:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010382a:	c7 40 14 f2 58 10 80 	movl   $0x801058f2,0x14(%eax)
  p->context = (struct context*)sp;
...
801038e6:	68 20 7d 10 80       	push   $0x80107d20
...
801039bc:	89 c3                	mov    %eax,%ebx
  initproc = p;
801039be:	a3 54 8d 11 80       	mov    %eax,0x80118d54
  if((p->pgdir = setupkvm()) == 0)
801039c3:	e8 28 36 00 00       	call   80106ff0 <setupkvm>
...
801039e1:	e8 ba 32 00 00       	call   80106ca0 <inituvm>
...
80103a4f:	68 50 7d 10 80       	push   $0x80107d50
80103a54:	50                   	push   %eax
80103a55:	e8 d6 0d 00 00       	call   80104830 <safestrcpy>
  p->cwd = namei("/");
80103a5a:	c7 04 24 59 7d 10 80 	movl   $0x80107d59,(%esp)
...
80103a93:	68 37 7d 10 80       	push   $0x80107d37
...
80103acb:	e8 c0 30 00 00       	call   80106b90 <switchuvm>
  return 0;
...
80103aea:	e8 21 33 00 00       	call   80106e10 <allocuvm>
...
80103b0a:	e8 31 34 00 00       	call   80106f40 <deallocuvm>
...
80103b58:	e8 83 35 00 00       	call   801070e0 <copyuvm>
...
80103c90:	e8 fb 2e 00 00       	call   80106b90 <switchuvm>
...
80103ca2:	e8 e4 0b 00 00       	call   8010488b <swtch>
      switchkvm();
80103ca7:	e8 d4 2e 00 00       	call   80106b80 <switchkvm>
      c->proc = 0;
80103cac:	83 c4 10             	add    $0x10,%esp
80103caf:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103cb6:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cb9:	81 c3 80 01 00 00    	add    $0x180,%ebx
80103cbf:	81 fb 54 8d 11 80    	cmp    $0x80118d54,%ebx
...
80103da9:	e8 d2 fb ff ff       	call   80103980 <myproc>
  if(curproc == initproc)
80103dae:	39 05 54 8d 11 80    	cmp    %eax,0x80118d54
...
80103e20:	05 80 01 00 00       	add    $0x180,%eax
80103e25:	3d 54 8d 11 80       	cmp    $0x80118d54,%eax
...
80103e37:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e3e:	05 80 01 00 00       	add    $0x180,%eax
80103e43:	3d 54 8d 11 80       	cmp    $0x80118d54,%eax
80103e48:	75 e2                	jne    80103e2c <exit+0x8c>
      p->parent = initproc;
80103e4a:	8b 0d 54 8d 11 80    	mov    0x80118d54,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103e60:	81 c2 80 01 00 00    	add    $0x180,%edx
80103e66:	81 fa 54 8d 11 80    	cmp    $0x80118d54,%edx
...
80103e87:	90                   	nop
80103e88:	05 80 01 00 00       	add    $0x180,%eax
80103e8d:	3d 54 8d 11 80       	cmp    $0x80118d54,%eax
...
80103eb7:	68 a8 7d 10 80       	push   $0x80107da8
80103ebc:	e8 bf c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103ec1:	83 ec 0c             	sub    $0xc,%esp
80103ec4:	68 9b 7d 10 80       	push   $0x80107d9b
...
80103f07:	90                   	nop
80103f08:	81 c3 80 01 00 00    	add    $0x180,%ebx
80103f0e:	81 fb 54 8d 11 80    	cmp    $0x80118d54,%ebx
...
80103f1f:	74 5f                	je     80103f80 <wait+0xb0>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f21:	81 c3 80 01 00 00    	add    $0x180,%ebx
      havekids = 1;
80103f27:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f2c:	81 fb 54 8d 11 80    	cmp    $0x80118d54,%ebx
...
80103f99:	e8 d2 2f 00 00       	call   80106f70 <freevm>
        p->pid = 0;
...
80103ff0:	68 b4 7d 10 80       	push   $0x80107db4
...
801040f9:	68 ba 7d 10 80       	push   $0x80107dba
801040fe:	e8 7d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
80104103:	83 ec 0c             	sub    $0xc,%esp
80104106:	68 b4 7d 10 80       	push   $0x80107db4
...
80104130:	05 80 01 00 00       	add    $0x180,%eax
80104135:	3d 54 8d 11 80       	cmp    $0x80118d54,%eax
...
80104147:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010414e:	05 80 01 00 00       	add    $0x180,%eax
80104153:	3d 54 8d 11 80       	cmp    $0x80118d54,%eax
...
80104190:	05 80 01 00 00       	add    $0x180,%eax
80104195:	3d 54 8d 11 80       	cmp    $0x80118d54,%eax
...
8010420b:	68 e7 81 10 80       	push   $0x801081e7
80104210:	e8 8b c4 ff ff       	call   801006a0 <cprintf>
80104215:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104218:	81 c3 80 01 00 00    	add    $0x180,%ebx
8010421e:	81 fb c0 8d 11 80    	cmp    $0x80118dc0,%ebx
...
8010422f:	74 e7                	je     80104218 <procdump+0x28>
      state = "???";
80104231:	ba cb 7d 10 80       	mov    $0x80107dcb,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104236:	83 f8 05             	cmp    $0x5,%eax
80104239:	77 11                	ja     8010424c <procdump+0x5c>
8010423b:	8b 14 85 2c 7e 10 80 	mov    -0x7fef81d4(,%eax,4),%edx
      state = "???";
80104242:	b8 cb 7d 10 80       	mov    $0x80107dcb,%eax
...
80104251:	68 cf 7d 10 80       	push   $0x80107dcf
...
8010428d:	68 21 78 10 80       	push   $0x80107821
...
801042ba:	68 44 7e 10 80       	push   $0x80107e44
...
801044f5:	68 4f 7e 10 80       	push   $0x80107e4f
801044fa:	e8 81 be ff ff       	call   80100380 <panic>
    panic("popcli");
801044ff:	83 ec 0c             	sub    $0xc,%esp
80104502:	68 66 7e 10 80       	push   $0x80107e66
...
8010456b:	68 6d 7e 10 80       	push   $0x80107e6d
...
80104660:	68 75 7e 10 80       	push   $0x80107e75
...
801048f3:	76 1b                	jbe    80104910 <fetchuint+0x30>
801048f5:	8d 53 04             	lea    0x4(%ebx),%edx
801048f8:	39 d0                	cmp    %edx,%eax
801048fa:	72 14                	jb     80104910 <fetchuint+0x30>
    return -1;
  *ip = *(uint*)(addr);
...
80104915:	eb ee                	jmp    80104905 <fetchuint+0x25>
...
// Edited: Fetch the nth 32-bit system call argument.
int arguint(int n, uint *up) {
801049c0:	55                   	push   %ebp
801049c1:	89 e5                	mov    %esp,%ebp
801049c3:	56                   	push   %esi
801049c4:	53                   	push   %ebx
    return fetchuint((myproc()->tf->esp) + 4 + 4 * n, up);
...
801049e2:	73 1c                	jae    80104a00 <arguint+0x40>
801049e4:	8d 53 08             	lea    0x8(%ebx),%edx
801049e7:	39 d0                	cmp    %edx,%eax
801049e9:	72 15                	jb     80104a00 <arguint+0x40>
  *ip = *(uint*)(addr);
...
80104a00:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    return fetchuint((myproc()->tf->esp) + 4 + 4 * n, up);
80104a05:	eb ee                	jmp    801049f5 <arguint+0x35>
...
80104b1c:	8b 14 85 a0 7e 10 80 	mov    -0x7fef8160(,%eax,4),%edx
...
80104b48:	68 7d 7e 10 80       	push   $0x80107e7d
80104b4d:	e8 4e bb ff ff       	call   801006a0 <cprintf>
    curproc->tf->eax = -1;
...
80104b87:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104b8a:	e8 31 d5 ff ff       	call   801020c0 <nameiparent>
...
80104bac:	e8 2f d1 ff ff       	call   80101ce0 <dirlookup>
...
80104bbe:	e8 4d ce ff ff       	call   80101a10 <iunlockput>
    ilock(ip);
80104bc3:	89 34 24             	mov    %esi,(%esp)
80104bc6:	e8 b5 cb ff ff       	call   80101780 <ilock>
...
80104bf4:	31 f6                	xor    %esi,%esi
    iunlockput(ip);
80104bf6:	e8 15 ce ff ff       	call   80101a10 <iunlockput>
    return 0;
...
80104c1a:	e8 f1 c9 ff ff       	call   80101610 <ialloc>
...
80104c51:	e8 7a ca ff ff       	call   801016d0 <iupdate>
...
80104c68:	e8 73 d3 ff ff       	call   80101fe0 <dirlink>
...
80104c78:	e8 93 cd ff ff       	call   80101a10 <iunlockput>
  return ip;
...
80104c99:	e8 32 ca ff ff       	call   801016d0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104c9e:	83 c4 0c             	add    $0xc,%esp
80104ca1:	ff 76 04             	push   0x4(%esi)
80104ca4:	68 28 7f 10 80       	push   $0x80107f28
80104ca9:	56                   	push   %esi
80104caa:	e8 31 d3 ff ff       	call   80101fe0 <dirlink>
...
80104cbc:	68 27 7f 10 80       	push   $0x80107f27
80104cc1:	56                   	push   %esi
80104cc2:	e8 19 d3 ff ff       	call   80101fe0 <dirlink>
...
80104cd1:	68 1b 7f 10 80       	push   $0x80107f1b
...
80104cef:	68 2a 7f 10 80       	push   $0x80107f2a
80104cf4:	e8 87 b6 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104cf9:	83 ec 0c             	sub    $0xc,%esp
80104cfc:	68 0c 7f 10 80       	push   $0x80107f0c
80104d01:	e8 7a b6 ff ff       	call   80100380 <panic>
...
80104d1e:	e8 4d fc ff ff       	call   80104970 <argint>
...
80104d78:	e8 23 c1 ff ff       	call   80100ea0 <filedup>
  return fd;
...
80104d9e:	e8 cd fb ff ff       	call   80104970 <argint>
...
80104dc9:	e8 a2 fb ff ff       	call   80104970 <argint>
...
80104dde:	e8 2d fc ff ff       	call   80104a10 <argptr>
...
80104df4:	e8 27 c2 ff ff       	call   80101020 <fileread>
...
80104e1e:	e8 4d fb ff ff       	call   80104970 <argint>
...
80104e49:	e8 22 fb ff ff       	call   80104970 <argint>
...
80104e5e:	e8 ad fb ff ff       	call   80104a10 <argptr>
...
80104e74:	e8 37 c2 ff ff       	call   801010b0 <filewrite>
...
80104e9e:	e8 cd fa ff ff       	call   80104970 <argint>
...
80104ec1:	74 25                	je     80104ee8 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80104ec3:	e8 b8 ea ff ff       	call   80103980 <myproc>
  fileclose(f);
...
80104ed4:	e8 17 c0 ff ff       	call   80100ef0 <fileclose>
  return 0;
...
80104efe:	e8 6d fa ff ff       	call   80104970 <argint>
...
80104f28:	e8 e3 fa ff ff       	call   80104a10 <argptr>
...
80104f3b:	e8 90 c0 ff ff       	call   80100fd0 <filestat>
...
80104f6f:	e8 0c fb ff ff       	call   80104a80 <argstr>
...
80104fd8:	e8 f3 c6 ff ff       	call   801016d0 <iupdate>
  iunlock(ip);
80104fdd:	89 1c 24             	mov    %ebx,(%esp)
80104fe0:	e8 7b c8 ff ff       	call   80101860 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104fe5:	58                   	pop    %eax
80104fe6:	5a                   	pop    %edx
80104fe7:	57                   	push   %edi
80104fe8:	ff 75 d0             	push   -0x30(%ebp)
80104feb:	e8 d0 d0 ff ff       	call   801020c0 <nameiparent>
...
80105013:	e8 c8 cf ff ff       	call   80101fe0 <dirlink>
...
80105023:	e8 e8 c9 ff ff       	call   80101a10 <iunlockput>
  iput(ip);
80105028:	89 1c 24             	mov    %ebx,(%esp)
8010502b:	e8 80 c8 ff ff       	call   801018b0 <iput>
  end_op();
80105030:	e8 9b dd ff ff       	call   80102dd0 <end_op>
  return 0;
...
8010504c:	e8 bf c9 ff ff       	call   80101a10 <iunlockput>
    goto bad;
...
80105065:	e8 66 c6 ff ff       	call   801016d0 <iupdate>
  iunlockput(ip);
8010506a:	89 1c 24             	mov    %ebx,(%esp)
8010506d:	e8 9e c9 ff ff       	call   80101a10 <iunlockput>
  end_op();
80105072:	e8 59 dd ff ff       	call   80102dd0 <end_op>
  return -1;
...
80105085:	e8 86 c9 ff ff       	call   80101a10 <iunlockput>
    end_op();
8010508a:	e8 41 dd ff ff       	call   80102dd0 <end_op>
    return -1;
8010508f:	83 c4 10             	add    $0x10,%esp
80105092:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105097:	eb a1                	jmp    8010503a <sys_link+0xda>
    end_op();
80105099:	e8 32 dd ff ff       	call   80102dd0 <end_op>
    return -1;
8010509e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801050a3:	eb 95                	jmp    8010503a <sys_link+0xda>
801050a5:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
801050b4:	56                   	push   %esi
  if(argstr(0, &path) < 0)
801050b5:	8d 45 c0             	lea    -0x40(%ebp),%eax
{
801050b8:	53                   	push   %ebx
801050b9:	83 ec 54             	sub    $0x54,%esp
  if(argstr(0, &path) < 0)
...
801050c9:	0f 88 7a 01 00 00    	js     80105249 <sys_unlink+0x199>
  begin_op();
801050cf:	e8 8c dc ff ff       	call   80102d60 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
801050d4:	8d 5d ca             	lea    -0x36(%ebp),%ebx
801050d7:	83 ec 08             	sub    $0x8,%esp
801050da:	53                   	push   %ebx
801050db:	ff 75 c0             	push   -0x40(%ebp)
801050de:	e8 dd cf ff ff       	call   801020c0 <nameiparent>
801050e3:	83 c4 10             	add    $0x10,%esp
801050e6:	89 45 b4             	mov    %eax,-0x4c(%ebp)
801050e9:	85 c0                	test   %eax,%eax
801050eb:	0f 84 62 01 00 00    	je     80105253 <sys_unlink+0x1a3>
  ilock(dp);
801050f1:	8b 7d b4             	mov    -0x4c(%ebp),%edi
...
801050fd:	58                   	pop    %eax
801050fe:	5a                   	pop    %edx
801050ff:	68 28 7f 10 80       	push   $0x80107f28
80105104:	53                   	push   %ebx
80105105:	e8 b6 cb ff ff       	call   80101cc0 <namecmp>
8010510a:	83 c4 10             	add    $0x10,%esp
8010510d:	85 c0                	test   %eax,%eax
8010510f:	0f 84 fb 00 00 00    	je     80105210 <sys_unlink+0x160>
80105115:	83 ec 08             	sub    $0x8,%esp
80105118:	68 27 7f 10 80       	push   $0x80107f27
8010511d:	53                   	push   %ebx
8010511e:	e8 9d cb ff ff       	call   80101cc0 <namecmp>
80105123:	83 c4 10             	add    $0x10,%esp
80105126:	85 c0                	test   %eax,%eax
80105128:	0f 84 e2 00 00 00    	je     80105210 <sys_unlink+0x160>
...
80105137:	e8 a4 cb ff ff       	call   80101ce0 <dirlookup>
8010513c:	83 c4 10             	add    $0x10,%esp
8010513f:	89 c3                	mov    %eax,%ebx
80105141:	85 c0                	test   %eax,%eax
80105143:	0f 84 c7 00 00 00    	je     80105210 <sys_unlink+0x160>
  ilock(ip);
...
8010515a:	0f 8e 1c 01 00 00    	jle    8010527c <sys_unlink+0x1cc>
...
80105172:	e8 f9 f4 ff ff       	call   80104670 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105177:	6a 10                	push   $0x10
80105179:	ff 75 c4             	push   -0x3c(%ebp)
8010517c:	57                   	push   %edi
8010517d:	ff 75 b4             	push   -0x4c(%ebp)
80105180:	e8 0b ca ff ff       	call   80101b90 <writei>
80105185:	83 c4 20             	add    $0x20,%esp
80105188:	83 f8 10             	cmp    $0x10,%eax
8010518b:	0f 85 de 00 00 00    	jne    8010526f <sys_unlink+0x1bf>
  if(ip->type == T_DIR){
80105191:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105196:	0f 84 94 00 00 00    	je     80105230 <sys_unlink+0x180>
  iunlockput(dp);
8010519c:	83 ec 0c             	sub    $0xc,%esp
8010519f:	ff 75 b4             	push   -0x4c(%ebp)
801051a2:	e8 69 c8 ff ff       	call   80101a10 <iunlockput>
  ip->nlink--;
801051a7:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
801051ac:	89 1c 24             	mov    %ebx,(%esp)
801051af:	e8 1c c5 ff ff       	call   801016d0 <iupdate>
  iunlockput(ip);
801051b4:	89 1c 24             	mov    %ebx,(%esp)
801051b7:	e8 54 c8 ff ff       	call   80101a10 <iunlockput>
  end_op();
801051bc:	e8 0f dc ff ff       	call   80102dd0 <end_op>
  return 0;
...
801051d6:	be 20 00 00 00       	mov    $0x20,%esi
801051db:	eb 0b                	jmp    801051e8 <sys_unlink+0x138>
801051dd:	8d 76 00             	lea    0x0(%esi),%esi
801051e0:	83 c6 10             	add    $0x10,%esi
801051e3:	3b 73 58             	cmp    0x58(%ebx),%esi
801051e6:	73 82                	jae    8010516a <sys_unlink+0xba>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801051e8:	6a 10                	push   $0x10
801051ea:	56                   	push   %esi
801051eb:	57                   	push   %edi
801051ec:	53                   	push   %ebx
801051ed:	e8 9e c8 ff ff       	call   80101a90 <readi>
801051f2:	83 c4 10             	add    $0x10,%esp
801051f5:	83 f8 10             	cmp    $0x10,%eax
801051f8:	75 68                	jne    80105262 <sys_unlink+0x1b2>
    if(de.inum != 0)
801051fa:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
801051ff:	74 df                	je     801051e0 <sys_unlink+0x130>
    iunlockput(ip);
80105201:	83 ec 0c             	sub    $0xc,%esp
80105204:	53                   	push   %ebx
80105205:	e8 06 c8 ff ff       	call   80101a10 <iunlockput>
    goto bad;
8010520a:	83 c4 10             	add    $0x10,%esp
8010520d:	8d 76 00             	lea    0x0(%esi),%esi
  iunlockput(dp);
80105210:	83 ec 0c             	sub    $0xc,%esp
80105213:	ff 75 b4             	push   -0x4c(%ebp)
...
80105228:	eb 9c                	jmp    801051c6 <sys_unlink+0x116>
8010522a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    dp->nlink--;
80105230:	8b 45 b4             	mov    -0x4c(%ebp),%eax
    iupdate(dp);
80105233:	83 ec 0c             	sub    $0xc,%esp
    dp->nlink--;
80105236:	66 83 68 56 01       	subw   $0x1,0x56(%eax)
    iupdate(dp);
8010523b:	50                   	push   %eax
8010523c:	e8 8f c4 ff ff       	call   801016d0 <iupdate>
80105241:	83 c4 10             	add    $0x10,%esp
80105244:	e9 53 ff ff ff       	jmp    8010519c <sys_unlink+0xec>
    return -1;
80105249:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010524e:	e9 73 ff ff ff       	jmp    801051c6 <sys_unlink+0x116>
    end_op();
80105253:	e8 78 db ff ff       	call   80102dd0 <end_op>
    return -1;
80105258:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010525d:	e9 64 ff ff ff       	jmp    801051c6 <sys_unlink+0x116>
      panic("isdirempty: readi");
80105262:	83 ec 0c             	sub    $0xc,%esp
80105265:	68 4c 7f 10 80       	push   $0x80107f4c
8010526a:	e8 11 b1 ff ff       	call   80100380 <panic>
    panic("unlink: writei");
8010526f:	83 ec 0c             	sub    $0xc,%esp
80105272:	68 5e 7f 10 80       	push   $0x80107f5e
80105277:	e8 04 b1 ff ff       	call   80100380 <panic>
    panic("unlink: nlink < 1");
8010527c:	83 ec 0c             	sub    $0xc,%esp
8010527f:	68 3a 7f 10 80       	push   $0x80107f3a
80105284:	e8 f7 b0 ff ff       	call   80100380 <panic>
...
8010529f:	e8 dc f7 ff ff       	call   80104a80 <argstr>
...
801052b8:	e8 b3 f6 ff ff       	call   80104970 <argint>
...
801052c2:	78 79                	js     8010533d <sys_open+0xad>
  ...
  begin_op();
801052c4:	e8 97 da ff ff       	call   80102d60 <begin_op>
...
801052d5:	e8 c6 cd ff ff       	call   801020a0 <namei>
...
801052eb:	e8 90 c4 ff ff       	call   80101780 <ilock>
...
801052fe:	e8 2d bb ff ff       	call   80100e30 <filealloc>
...
80105330:	e8 db c6 ff ff       	call   80101a10 <iunlockput>
    end_op();
...
80105357:	e8 14 f8 ff ff       	call   80104b70 <create>
    if(ip == 0){
...
801053ff:	e8 6c f7 ff ff       	call   80104b70 <create>
...
8010540f:	e8 fc c5 ff ff       	call   80101a10 <iunlockput>
  end_op();
80105414:	e8 b7 d9 ff ff       	call   80102dd0 <end_op>
  return 0;
...
80105459:	e8 12 f5 ff ff       	call   80104970 <argint>
  if((argstr(0, &path)) < 0 ||
...
8010546e:	e8 fd f4 ff ff       	call   80104970 <argint>
     argint(1, &major) < 0 ||
...
8010548e:	e8 dd f6 ff ff       	call   80104b70 <create>
     argint(2, &minor) < 0 ||
...
8010549e:	e8 6d c5 ff ff       	call   80101a10 <iunlockput>
  end_op();
...
801054c5:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801054c8:	e8 b3 e4 ff ff       	call   80103980 <myproc>
801054cd:	89 c6                	mov    %eax,%esi
  
  begin_op();
801054cf:	e8 8c d8 ff ff       	call   80102d60 <begin_op>
...
801054ef:	e8 ac cb ff ff       	call   801020a0 <namei>
...
80105501:	e8 7a c2 ff ff       	call   80101780 <ilock>
  if(ip->type != T_DIR){
...
80105514:	e8 47 c3 ff ff       	call   80101860 <iunlock>
  iput(curproc->cwd);
80105519:	58                   	pop    %eax
8010551a:	ff 76 68             	push   0x68(%esi)
8010551d:	e8 8e c3 ff ff       	call   801018b0 <iput>
  end_op();
...
801055a1:	e8 ca f3 ff ff       	call   80104970 <argint>
...
801055c0:	e8 ab f0 ff ff       	call   80104670 <memset>
...
801055ea:	e8 b1 f2 ff ff       	call   801048a0 <fetchint>
...
80105608:	e8 13 f3 ff ff       	call   80104920 <fetchstr>
...
80105671:	e8 9a f3 ff ff       	call   80104a10 <argptr>
...
80105680:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105683:	50                   	push   %eax
80105684:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105687:	50                   	push   %eax
80105688:	e8 a3 dd ff ff       	call   80103430 <pipealloc>
...
80105694:	8b 7d e0             	mov    -0x20(%ebp),%edi
  for(fd = 0; fd < NOFILE; fd++){
80105697:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105699:	e8 e2 e2 ff ff       	call   80103980 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801056b3:	ff 75 e0             	push   -0x20(%ebp)
801056b6:	e8 35 b8 ff ff       	call   80100ef0 <fileclose>
    fileclose(wf);
801056bb:	58                   	pop    %eax
801056bc:	ff 75 e4             	push   -0x1c(%ebp)
801056bf:	e8 2c b8 ff ff       	call   80100ef0 <fileclose>
    return -1;
801056c4:	83 c4 10             	add    $0x10,%esp
801056c7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801056cc:	eb 53                	jmp    80105721 <sys_pipe+0xc1>
...
801056ee:	74 20                	je     80105710 <sys_pipe+0xb0>
  for(fd = 0; fd < NOFILE; fd++){
801056f0:	83 c2 01             	add    $0x1,%edx
801056f3:	83 fa 10             	cmp    $0x10,%edx
801056f6:	75 f0                	jne    801056e8 <sys_pipe+0x88>
      myproc()->ofile[fd0] = 0;
801056f8:	e8 83 e2 ff ff       	call   80103980 <myproc>
801056fd:	c7 44 b0 08 00 00 00 	movl   $0x0,0x8(%eax,%esi,4)
80105704:	00 
80105705:	eb a9                	jmp    801056b0 <sys_pipe+0x50>
...
{
  return fork();
80105730:	e9 eb e3 ff ff       	jmp    80103b20 <fork>
...
80105743:	83 ec 08             	sub    $0x8,%esp
  exit();
80105746:	e8 55 e6 ff ff       	call   80103da0 <exit>
...
{
  return wait();
80105750:	e9 7b e7 ff ff       	jmp    80103ed0 <wait>
...
8010576c:	e8 ff f1 ff ff       	call   80104970 <argint>
...
8010577e:	e8 ed e9 ff ff       	call   80104170 <kill>
...
801057c7:	78 27                	js     801057f0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801057c9:	e8 b2 e1 ff ff       	call   80103980 <myproc>
  if(growproc(n) < 0)
...
801057d6:	e8 c5 e2 ff ff       	call   80103aa0 <growproc>
...
8010580d:	e8 5e f1 ff ff       	call   80104970 <argint>
...
80105820:	68 80 8d 11 80       	push   $0x80118d80
80105825:	e8 86 ed ff ff       	call   801045b0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010582a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010582d:	8b 1d 60 8d 11 80    	mov    0x80118d60,%ebx
  while(ticks - ticks0 < n){
...
80105843:	68 80 8d 11 80       	push   $0x80118d80
80105848:	68 60 8d 11 80       	push   $0x80118d60
8010584d:	e8 fe e7 ff ff       	call   80104050 <sleep>
  while(ticks - ticks0 < n){
80105852:	a1 60 8d 11 80       	mov    0x80118d60,%eax
...
80105870:	68 80 8d 11 80       	push   $0x80118d80
...
80105893:	68 80 8d 11 80       	push   $0x80118d80
...
801058b4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801058b7:	68 80 8d 11 80       	push   $0x80118d80
801058bc:	e8 ef ec ff ff       	call   801045b0 <acquire>
  xticks = ticks;
801058c1:	8b 1d 60 8d 11 80    	mov    0x80118d60,%ebx
  release(&tickslock);
801058c7:	c7 04 24 80 8d 11 80 	movl   $0x80118d80,(%esp)
...
80105910:	8b 14 85 08 b0 10 80 	mov    -0x7fef4ff8(,%eax,4),%edx
80105917:	c7 04 c5 c2 8d 11 80 	movl   $0x8e000008,-0x7fee723e(,%eax,8)
8010591e:	08 00 00 8e 
80105922:	66 89 14 c5 c0 8d 11 	mov    %dx,-0x7fee7240(,%eax,8)
80105929:	80 
8010592a:	c1 ea 10             	shr    $0x10,%edx
8010592d:	66 89 14 c5 c6 8d 11 	mov    %dx,-0x7fee723a(,%eax,8)
80105934:	80 
  for(i = 0; i < 256; i++)
...
8010593f:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105942:	a1 08 b1 10 80       	mov    0x8010b108,%eax
80105947:	c7 05 c2 8f 11 80 08 	movl   $0xef000008,0x80118fc2
8010594e:	00 00 ef 
  initlock(&tickslock, "time");
80105951:	68 6d 7f 10 80       	push   $0x80107f6d
80105956:	68 80 8d 11 80       	push   $0x80118d80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010595b:	66 a3 c0 8f 11 80    	mov    %ax,0x80118fc0
80105961:	c1 e8 10             	shr    $0x10,%eax
80105964:	66 a3 c6 8f 11 80    	mov    %ax,0x80118fc6
  initlock(&tickslock, "time");
...
8010598b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010598f:	b8 c0 8d 11 80       	mov    $0x80118dc0,%eax
...
801059c2:	0f 84 38 01 00 00    	je     80105b00 <trap+0x150>
    if(myproc()->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
801059c8:	83 e8 0e             	sub    $0xe,%eax
801059cb:	83 f8 31             	cmp    $0x31,%eax
801059ce:	0f 87 8c 00 00 00    	ja     80105a60 <trap+0xb0>
801059d4:	ff 24 85 68 80 10 80 	jmp    *-0x7fef7f98(,%eax,4)
801059db:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801059df:	90                   	nop
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
801059e0:	e8 7b df ff ff       	call   80103960 <cpuid>
801059e5:	85 c0                	test   %eax,%eax
801059e7:	0f 84 53 02 00 00    	je     80105c40 <trap+0x290>
    }
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE:
    ideintr();
    lapiceoi();
801059ed:	e8 1e cf ff ff       	call   80102910 <lapiceoi>
  }
...
801059f9:	74 1d                	je     80105a18 <trap+0x68>
801059fb:	e8 80 df ff ff       	call   80103980 <myproc>
80105a00:	8b 50 24             	mov    0x24(%eax),%edx
80105a03:	85 d2                	test   %edx,%edx
80105a05:	74 11                	je     80105a18 <trap+0x68>
80105a07:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105a0b:	83 e0 03             	and    $0x3,%eax
80105a0e:	66 83 f8 03          	cmp    $0x3,%ax
80105a12:	0f 84 08 02 00 00    	je     80105c20 <trap+0x270>
    exit();
...
80105a1f:	74 0f                	je     80105a30 <trap+0x80>
80105a21:	e8 5a df ff ff       	call   80103980 <myproc>
80105a26:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105a2a:	0f 84 b8 00 00 00    	je     80105ae8 <trap+0x138>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a30:	e8 4b df ff ff       	call   80103980 <myproc>
80105a35:	85 c0                	test   %eax,%eax
80105a37:	74 1d                	je     80105a56 <trap+0xa6>
80105a39:	e8 42 df ff ff       	call   80103980 <myproc>
80105a3e:	8b 40 24             	mov    0x24(%eax),%eax
80105a41:	85 c0                	test   %eax,%eax
80105a43:	74 11                	je     80105a56 <trap+0xa6>
80105a45:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105a49:	83 e0 03             	and    $0x3,%eax
80105a4c:	66 83 f8 03          	cmp    $0x3,%ax
80105a50:	0f 84 d7 00 00 00    	je     80105b2d <trap+0x17d>
    exit();
...
80105a60:	e8 1b df ff ff       	call   80103980 <myproc>
80105a65:	85 c0                	test   %eax,%eax
80105a67:	0f 84 07 02 00 00    	je     80105c74 <trap+0x2c4>
80105a6d:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105a71:	0f 84 fd 01 00 00    	je     80105c74 <trap+0x2c4>
...
80105a7a:	8b 53 38             	mov    0x38(%ebx),%edx
80105a7d:	89 4d d8             	mov    %ecx,-0x28(%ebp)
80105a80:	89 55 dc             	mov    %edx,-0x24(%ebp)
80105a83:	e8 d8 de ff ff       	call   80103960 <cpuid>
80105a88:	8b 73 30             	mov    0x30(%ebx),%esi
80105a8b:	89 c7                	mov    %eax,%edi
80105a8d:	8b 43 34             	mov    0x34(%ebx),%eax
80105a90:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            myproc()->pid, myproc()->name, tf->trapno,
80105a93:	e8 e8 de ff ff       	call   80103980 <myproc>
80105a98:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105a9b:	e8 e0 de ff ff       	call   80103980 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105aa0:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80105aa3:	8b 55 dc             	mov    -0x24(%ebp),%edx
80105aa6:	51                   	push   %ecx
80105aa7:	52                   	push   %edx
80105aa8:	57                   	push   %edi
80105aa9:	ff 75 e4             	push   -0x1c(%ebp)
80105aac:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
80105aad:	8b 75 e0             	mov    -0x20(%ebp),%esi
80105ab0:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105ab3:	56                   	push   %esi
80105ab4:	ff 70 10             	push   0x10(%eax)
80105ab7:	68 24 80 10 80       	push   $0x80108024
80105abc:	e8 df ab ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105ac1:	83 c4 20             	add    $0x20,%esp
80105ac4:	e8 b7 de ff ff       	call   80103980 <myproc>
80105ac9:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ad0:	e8 ab de ff ff       	call   80103980 <myproc>
80105ad5:	85 c0                	test   %eax,%eax
80105ad7:	0f 85 1e ff ff ff    	jne    801059fb <trap+0x4b>
80105add:	e9 36 ff ff ff       	jmp    80105a18 <trap+0x68>
80105ae2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  if(myproc() && myproc()->state == RUNNING &&
80105ae8:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105aec:	0f 85 3e ff ff ff    	jne    80105a30 <trap+0x80>
    yield();
80105af2:	e8 09 e5 ff ff       	call   80104000 <yield>
80105af7:	e9 34 ff ff ff       	jmp    80105a30 <trap+0x80>
...
80105b0a:	0f 85 20 01 00 00    	jne    80105c30 <trap+0x280>
    myproc()->tf = tf;
...
80105b18:	e8 e3 ef ff ff       	call   80104b00 <syscall>
    if(myproc()->killed)
80105b1d:	e8 5e de ff ff       	call   80103980 <myproc>
80105b22:	8b 58 24             	mov    0x24(%eax),%ebx
80105b25:	85 db                	test   %ebx,%ebx
80105b27:	0f 84 29 ff ff ff    	je     80105a56 <trap+0xa6>
...
80105b33:	5d                   	pop    %ebp
      exit();
80105b34:	e9 67 e2 ff ff       	jmp    80103da0 <exit>
80105b39:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105b40:	8b 7b 38             	mov    0x38(%ebx),%edi
80105b43:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105b47:	e8 14 de ff ff       	call   80103960 <cpuid>
80105b4c:	57                   	push   %edi
80105b4d:	56                   	push   %esi
80105b4e:	50                   	push   %eax
80105b4f:	68 a0 7f 10 80       	push   $0x80107fa0
80105b54:	e8 47 ab ff ff       	call   801006a0 <cprintf>
    lapiceoi();
80105b59:	e8 b2 cd ff ff       	call   80102910 <lapiceoi>
    break;
80105b5e:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b61:	e8 1a de ff ff       	call   80103980 <myproc>
80105b66:	85 c0                	test   %eax,%eax
80105b68:	0f 85 8d fe ff ff    	jne    801059fb <trap+0x4b>
80105b6e:	e9 a5 fe ff ff       	jmp    80105a18 <trap+0x68>
80105b73:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105b77:	90                   	nop
    kbdintr();
80105b78:	e8 53 cc ff ff       	call   801027d0 <kbdintr>
    lapiceoi();
80105b7d:	e8 8e cd ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b82:	e8 f9 dd ff ff       	call   80103980 <myproc>
80105b87:	85 c0                	test   %eax,%eax
80105b89:	0f 85 6c fe ff ff    	jne    801059fb <trap+0x4b>
80105b8f:	e9 84 fe ff ff       	jmp    80105a18 <trap+0x68>
80105b94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105b98:	e8 93 02 00 00       	call   80105e30 <uartintr>
    lapiceoi();
80105b9d:	e8 6e cd ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ba2:	e8 d9 dd ff ff       	call   80103980 <myproc>
80105ba7:	85 c0                	test   %eax,%eax
80105ba9:	0f 85 4c fe ff ff    	jne    801059fb <trap+0x4b>
80105baf:	e9 64 fe ff ff       	jmp    80105a18 <trap+0x68>
80105bb4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ideintr();
80105bb8:	e8 83 c6 ff ff       	call   80102240 <ideintr>
80105bbd:	e9 2b fe ff ff       	jmp    801059ed <trap+0x3d>
80105bc2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80105bc8:	0f 20 d6             	mov    %cr2,%esi
    struct proc *curproc = myproc();
80105bcb:	e8 b0 dd ff ff       	call   80103980 <myproc>
80105bd0:	89 c7                	mov    %eax,%edi
    if (!(tf->cs & 0x3)) {
80105bd2:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105bd6:	0f 84 c3 00 00 00    	je     80105c9f <trap+0x2ef>
    if (allocuvm(curproc->pgdir, PGROUNDDOWN(va), va + PGSIZE) == 0) {
80105bdc:	83 ec 04             	sub    $0x4,%esp
80105bdf:	8d 86 00 10 00 00    	lea    0x1000(%esi),%eax
80105be5:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
80105beb:	50                   	push   %eax
80105bec:	56                   	push   %esi
80105bed:	ff 77 04             	push   0x4(%edi)
80105bf0:	e8 1b 12 00 00       	call   80106e10 <allocuvm>
80105bf5:	83 c4 10             	add    $0x10,%esp
80105bf8:	85 c0                	test   %eax,%eax
80105bfa:	0f 85 f2 fd ff ff    	jne    801059f2 <trap+0x42>
      cprintf("page allocation failed, killing process\n");
80105c00:	83 ec 0c             	sub    $0xc,%esp
80105c03:	68 c4 7f 10 80       	push   $0x80107fc4
80105c08:	e8 93 aa ff ff       	call   801006a0 <cprintf>
      curproc->killed = 1;
80105c0d:	c7 47 24 01 00 00 00 	movl   $0x1,0x24(%edi)
      return;
80105c14:	83 c4 10             	add    $0x10,%esp
80105c17:	e9 3a fe ff ff       	jmp    80105a56 <trap+0xa6>
80105c1c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    exit();
80105c20:	e8 7b e1 ff ff       	call   80103da0 <exit>
80105c25:	e9 ee fd ff ff       	jmp    80105a18 <trap+0x68>
80105c2a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105c30:	e8 6b e1 ff ff       	call   80103da0 <exit>
80105c35:	e9 d6 fe ff ff       	jmp    80105b10 <trap+0x160>
80105c3a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105c40:	83 ec 0c             	sub    $0xc,%esp
80105c43:	68 80 8d 11 80       	push   $0x80118d80
80105c48:	e8 63 e9 ff ff       	call   801045b0 <acquire>
      wakeup(&ticks);
80105c4d:	c7 04 24 60 8d 11 80 	movl   $0x80118d60,(%esp)
      ticks++;
80105c54:	83 05 60 8d 11 80 01 	addl   $0x1,0x80118d60
      wakeup(&ticks);
80105c5b:	e8 b0 e4 ff ff       	call   80104110 <wakeup>
      release(&tickslock);
80105c60:	c7 04 24 80 8d 11 80 	movl   $0x80118d80,(%esp)
80105c67:	e8 e4 e8 ff ff       	call   80104550 <release>
80105c6c:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105c6f:	e9 79 fd ff ff       	jmp    801059ed <trap+0x3d>
80105c74:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105c77:	8b 73 38             	mov    0x38(%ebx),%esi
80105c7a:	e8 e1 dc ff ff       	call   80103960 <cpuid>
80105c7f:	83 ec 0c             	sub    $0xc,%esp
80105c82:	57                   	push   %edi
80105c83:	56                   	push   %esi
80105c84:	50                   	push   %eax
80105c85:	ff 73 30             	push   0x30(%ebx)
80105c88:	68 f0 7f 10 80       	push   $0x80107ff0
80105c8d:	e8 0e aa ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105c92:	83 c4 14             	add    $0x14,%esp
80105c95:	68 99 7f 10 80       	push   $0x80107f99
80105c9a:	e8 e1 a6 ff ff       	call   80100380 <panic>
      cprintf("kernel fault va %p ip %p\n", va, tf->eip);
80105c9f:	51                   	push   %ecx
80105ca0:	ff 73 38             	push   0x38(%ebx)
80105ca3:	56                   	push   %esi
80105ca4:	68 72 7f 10 80       	push   $0x80107f72
80105ca9:	e8 f2 a9 ff ff       	call   801006a0 <cprintf>
      panic("kernel fault");
80105cae:	c7 04 24 8c 7f 10 80 	movl   $0x80107f8c,(%esp)
...
{
  if(!uart)
80105cc0:	a1 c0 95 11 80       	mov    0x801195c0,%eax
...
80105d47:	74 78                	je     80105dc1 <uartinit+0xd1>
  uart = 1;
80105d49:	c7 05 c0 95 11 80 01 	movl   $0x1,0x801195c0
80105d50:	00 00 00 
...
80105d5c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105d5f:	bf 30 81 10 80       	mov    $0x80108130,%edi
...
80105d79:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80105d80:	a1 c0 95 11 80       	mov    0x801195c0,%eax
...
80105dd0 <uartputc>:
  if(!uart)
80105dd0:	a1 c0 95 11 80       	mov    0x801195c0,%eax
...
80105e47:	6a 00                	push   $0x0
  jmp alltraps
80105e49:	e9 8c fa ff ff       	jmp    801058da <alltraps>
...
80105e50:	6a 01                	push   $0x1
  jmp alltraps
80105e52:	e9 83 fa ff ff       	jmp    801058da <alltraps>
...
80105e59:	6a 02                	push   $0x2
  jmp alltraps
80105e5b:	e9 7a fa ff ff       	jmp    801058da <alltraps>
...
80105e62:	6a 03                	push   $0x3
  jmp alltraps
80105e64:	e9 71 fa ff ff       	jmp    801058da <alltraps>
...
80105e6b:	6a 04                	push   $0x4
  jmp alltraps
80105e6d:	e9 68 fa ff ff       	jmp    801058da <alltraps>
...
80105e74:	6a 05                	push   $0x5
  jmp alltraps
80105e76:	e9 5f fa ff ff       	jmp    801058da <alltraps>
...
80105e7d:	6a 06                	push   $0x6
  jmp alltraps
80105e7f:	e9 56 fa ff ff       	jmp    801058da <alltraps>
...
80105e86:	6a 07                	push   $0x7
  jmp alltraps
80105e88:	e9 4d fa ff ff       	jmp    801058da <alltraps>
...
80105e8d:	6a 08                	push   $0x8
  jmp alltraps
80105e8f:	e9 46 fa ff ff       	jmp    801058da <alltraps>
...
80105e96:	6a 09                	push   $0x9
  jmp alltraps
80105e98:	e9 3d fa ff ff       	jmp    801058da <alltraps>
...
80105e9d:	6a 0a                	push   $0xa
  jmp alltraps
80105e9f:	e9 36 fa ff ff       	jmp    801058da <alltraps>
...
80105ea4:	6a 0b                	push   $0xb
  jmp alltraps
80105ea6:	e9 2f fa ff ff       	jmp    801058da <alltraps>
...
80105eab:	6a 0c                	push   $0xc
  jmp alltraps
80105ead:	e9 28 fa ff ff       	jmp    801058da <alltraps>
...
80105eb2:	6a 0d                	push   $0xd
  jmp alltraps
80105eb4:	e9 21 fa ff ff       	jmp    801058da <alltraps>
...
80105eb9:	6a 0e                	push   $0xe
  jmp alltraps
80105ebb:	e9 1a fa ff ff       	jmp    801058da <alltraps>
...
80105ec2:	6a 0f                	push   $0xf
  jmp alltraps
80105ec4:	e9 11 fa ff ff       	jmp    801058da <alltraps>
...
80105ecb:	6a 10                	push   $0x10
  jmp alltraps
80105ecd:	e9 08 fa ff ff       	jmp    801058da <alltraps>
...
80106229:	6a 70                	push   $0x70
  jmp alltraps
8010622b:	e9 aa f6 ff ff       	jmp    801058da <alltraps>
...
80106232:	6a 71                	push   $0x71
  jmp alltraps
80106234:	e9 a1 f6 ff ff       	jmp    801058da <alltraps>
...
8010623b:	6a 72                	push   $0x72
  jmp alltraps
8010623d:	e9 98 f6 ff ff       	jmp    801058da <alltraps>
...
8010624d:	6a 74                	push   $0x74
  jmp alltraps
8010624f:	e9 86 f6 ff ff       	jmp    801058da <alltraps>
...
80106256:	6a 75                	push   $0x75
  jmp alltraps
80106258:	e9 7d f6 ff ff       	jmp    801058da <alltraps>
...
8010625f:	6a 76                	push   $0x76
  jmp alltraps
80106261:	e9 74 f6 ff ff       	jmp    801058da <alltraps>
...
80106271:	6a 78                	push   $0x78
  jmp alltraps
80106273:	e9 62 f6 ff ff       	jmp    801058da <alltraps>
...
8010627a:	6a 79                	push   $0x79
  jmp alltraps
8010627c:	e9 59 f6 ff ff       	jmp    801058da <alltraps>
...
80106283:	6a 7a                	push   $0x7a
  jmp alltraps
80106285:	e9 50 f6 ff ff       	jmp    801058da <alltraps>
...
80106295:	6a 7c                	push   $0x7c
  jmp alltraps
80106297:	e9 3e f6 ff ff       	jmp    801058da <alltraps>
...
8010629e:	6a 7d                	push   $0x7d
  jmp alltraps
801062a0:	e9 35 f6 ff ff       	jmp    801058da <alltraps>
...
801062a7:	6a 7e                	push   $0x7e
  jmp alltraps
801062a9:	e9 2c f6 ff ff       	jmp    801058da <alltraps>
...
80106829:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010682e:	e9 a7 f0 ff ff       	jmp    801058da <alltraps>
...
80106835:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010683a:	e9 9b f0 ff ff       	jmp    801058da <alltraps>
...
80106841:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106846:	e9 8f f0 ff ff       	jmp    801058da <alltraps>
...
8010684d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106852:	e9 83 f0 ff ff       	jmp    801058da <alltraps>
...
80106859:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010685e:	e9 77 f0 ff ff       	jmp    801058da <alltraps>
...
80106865:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010686a:	e9 6b f0 ff ff       	jmp    801058da <alltraps>
...
80106871:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106876:	e9 5f f0 ff ff       	jmp    801058da <alltraps>
...
8010687d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106882:	e9 53 f0 ff ff       	jmp    801058da <alltraps>
...
80106889:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010688e:	e9 47 f0 ff ff       	jmp    801058da <alltraps>
...
80106895:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010689a:	e9 3b f0 ff ff       	jmp    801058da <alltraps>
...
801068a1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801068a6:	e9 2f f0 ff ff       	jmp    801058da <alltraps>
...
801068ad:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801068b2:	e9 23 f0 ff ff       	jmp    801058da <alltraps>
...
8010695f:	68 46 7a 10 80       	push   $0x80107a46
...
80106973:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106976:	e8 e5 cf ff ff       	call   80103960 <cpuid>
  pd[0] = size-1;
...
8010698a:	c7 80 18 28 11 80 ff 	movl   $0xffff,-0x7feed7e8(%eax)
80106991:	ff 00 00 
80106994:	c7 80 1c 28 11 80 00 	movl   $0xcf9a00,-0x7feed7e4(%eax)
8010699b:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010699e:	c7 80 20 28 11 80 ff 	movl   $0xffff,-0x7feed7e0(%eax)
801069a5:	ff 00 00 
801069a8:	c7 80 24 28 11 80 00 	movl   $0xcf9200,-0x7feed7dc(%eax)
801069af:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801069b2:	c7 80 28 28 11 80 ff 	movl   $0xffff,-0x7feed7d8(%eax)
801069b9:	ff 00 00 
801069bc:	c7 80 2c 28 11 80 00 	movl   $0xcffa00,-0x7feed7d4(%eax)
801069c3:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801069c6:	c7 80 30 28 11 80 ff 	movl   $0xffff,-0x7feed7d0(%eax)
801069cd:	ff 00 00 
801069d0:	c7 80 34 28 11 80 00 	movl   $0xcff200,-0x7feed7cc(%eax)
801069d7:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
801069da:	05 10 28 11 80       	add    $0x80112810,%eax
  pd[1] = (uint)p;
...
80106a09:	8b 7d 0c             	mov    0xc(%ebp),%edi
  pde = &pgdir[PDX(va)];
80106a0c:	8b 55 08             	mov    0x8(%ebp),%edx
80106a0f:	89 fe                	mov    %edi,%esi
80106a11:	c1 ee 16             	shr    $0x16,%esi
80106a14:	8d 34 b2             	lea    (%edx,%esi,4),%esi
  if(*pde & PTE_P){
80106a17:	8b 1e                	mov    (%esi),%ebx
80106a19:	f6 c3 01             	test   $0x1,%bl
80106a1c:	74 22                	je     80106a40 <walkpgdir+0x40>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106a1e:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80106a24:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
  return &pgtab[PTX(va)];
80106a2a:	89 f8                	mov    %edi,%eax
}
80106a2c:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return &pgtab[PTX(va)];
80106a2f:	c1 e8 0a             	shr    $0xa,%eax
80106a32:	25 fc 0f 00 00       	and    $0xffc,%eax
80106a37:	01 d8                	add    %ebx,%eax
}
80106a39:	5b                   	pop    %ebx
80106a3a:	5e                   	pop    %esi
80106a3b:	5f                   	pop    %edi
...
80106a40:	8b 45 10             	mov    0x10(%ebp),%eax
80106a43:	85 c0                	test   %eax,%eax
80106a45:	74 31                	je     80106a78 <walkpgdir+0x78>
80106a47:	e8 34 bc ff ff       	call   80102680 <kalloc>
80106a4c:	89 c3                	mov    %eax,%ebx
80106a4e:	85 c0                	test   %eax,%eax
80106a50:	74 26                	je     80106a78 <walkpgdir+0x78>
    memset(pgtab, 0, PGSIZE);
80106a52:	83 ec 04             	sub    $0x4,%esp
80106a55:	68 00 10 00 00       	push   $0x1000
80106a5a:	6a 00                	push   $0x0
80106a5c:	50                   	push   %eax
80106a5d:	e8 0e dc ff ff       	call   80104670 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106a62:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106a68:	83 c4 10             	add    $0x10,%esp
80106a6b:	83 c8 07             	or     $0x7,%eax
80106a6e:	89 06                	mov    %eax,(%esi)
80106a70:	eb b8                	jmp    80106a2a <walkpgdir+0x2a>
...
80106a9c:	8b 55 10             	mov    0x10(%ebp),%edx
  a = (char*)PGROUNDDOWN((uint)va);
80106a9f:	89 c3                	mov    %eax,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106aa1:	8d 44 10 ff          	lea    -0x1(%eax,%edx,1),%eax
80106aa5:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  a = (char*)PGROUNDDOWN((uint)va);
80106aaa:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106ab0:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106ab3:	8b 45 14             	mov    0x14(%ebp),%eax
80106ab6:	29 d8                	sub    %ebx,%eax
80106ab8:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106abb:	eb 3a                	jmp    80106af7 <mappages+0x67>
...
80106b1a:	89 45 dc             	mov    %eax,-0x24(%ebp)
80106b1d:	68 00 10 00 00       	push   $0x1000
80106b22:	6a 00                	push   $0x0
80106b24:	50                   	push   %eax
80106b25:	e8 46 db ff ff       	call   80104670 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106b2a:	8b 55 dc             	mov    -0x24(%ebp),%edx
  return &pgtab[PTX(va)];
...
80106b6d:	68 38 81 10 80       	push   $0x80108138
...
80106b80:	a1 c4 95 11 80       	mov    0x801195c4,%eax
...
80106bb4:	0f 84 c2 00 00 00    	je     80106c7c <switchuvm+0xec>
  pushcli();
80106bba:	e8 a1 d8 ff ff       	call   80104460 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106bbf:	e8 3c cd ff ff       	call   80103900 <mycpu>
80106bc4:	89 c3                	mov    %eax,%ebx
80106bc6:	e8 35 cd ff ff       	call   80103900 <mycpu>
80106bcb:	89 c7                	mov    %eax,%edi
80106bcd:	e8 2e cd ff ff       	call   80103900 <mycpu>
80106bd2:	83 c7 08             	add    $0x8,%edi
80106bd5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106bd8:	e8 23 cd ff ff       	call   80103900 <mycpu>
...
80106c21:	e8 da cc ff ff       	call   80103900 <mycpu>
...
80106c44:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106c47:	e8 b4 cc ff ff       	call   80103900 <mycpu>
...
80106cac:	8b 55 08             	mov    0x8(%ebp),%edx
80106caf:	8b 7d 0c             	mov    0xc(%ebp),%edi
  if(sz >= PGSIZE)
80106cb2:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
80106cb8:	77 50                	ja     80106d0a <inituvm+0x6a>
80106cba:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  mem = kalloc();
...
80106ccf:	e8 9c d9 ff ff       	call   80104670 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80106cd4:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106cd7:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106cdd:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
80106ce4:	50                   	push   %eax
80106ce5:	68 00 10 00 00       	push   $0x1000
80106cea:	6a 00                	push   $0x0
80106cec:	52                   	push   %edx
80106ced:	e8 9e fd ff ff       	call   80106a90 <mappages>
  memmove(mem, init, sz);
80106cf2:	89 75 10             	mov    %esi,0x10(%ebp)
80106cf5:	83 c4 20             	add    $0x20,%esp
80106cf8:	89 7d 0c             	mov    %edi,0xc(%ebp)
80106cfb:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
...
80106d04:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106d05:	e9 06 da ff ff       	jmp    80104710 <memmove>
    panic("inituvm: more than a page");
80106d0a:	83 ec 0c             	sub    $0xc,%esp
80106d0d:	68 7d 81 10 80       	push   $0x8010817d
...
80106d70:	68 97 81 10 80       	push   $0x80108197
...
80106df8:	68 38 82 10 80       	push   $0x80108238
...
80106e1e:	0f 88 bc 00 00 00    	js     80106ee0 <allocuvm+0xd0>
  if(newsz < oldsz)
80106e24:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106e27:	0f 82 a3 00 00 00    	jb     80106ed0 <allocuvm+0xc0>
  a = PGROUNDUP(oldsz);
80106e2d:	8b 45 0c             	mov    0xc(%ebp),%eax
80106e30:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
80106e36:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for(; a < newsz; a += PGSIZE){
80106e3c:	39 75 10             	cmp    %esi,0x10(%ebp)
80106e3f:	0f 86 8e 00 00 00    	jbe    80106ed3 <allocuvm+0xc3>
80106e45:	89 7d e4             	mov    %edi,-0x1c(%ebp)
80106e48:	8b 7d 08             	mov    0x8(%ebp),%edi
80106e4b:	eb 43                	jmp    80106e90 <allocuvm+0x80>
...
80106e5b:	e8 10 d8 ff ff       	call   80104670 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106e60:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106e66:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
80106e6d:	50                   	push   %eax
80106e6e:	68 00 10 00 00       	push   $0x1000
80106e73:	56                   	push   %esi
80106e74:	57                   	push   %edi
80106e75:	e8 16 fc ff ff       	call   80106a90 <mappages>
80106e7a:	83 c4 20             	add    $0x20,%esp
80106e7d:	85 c0                	test   %eax,%eax
80106e7f:	78 6f                	js     80106ef0 <allocuvm+0xe0>
  for(; a < newsz; a += PGSIZE){
80106e81:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106e87:	39 75 10             	cmp    %esi,0x10(%ebp)
80106e8a:	0f 86 a0 00 00 00    	jbe    80106f30 <allocuvm+0x120>
    mem = kalloc();
80106e90:	e8 eb b7 ff ff       	call   80102680 <kalloc>
80106e95:	89 c3                	mov    %eax,%ebx
    if(mem == 0){
80106e97:	85 c0                	test   %eax,%eax
80106e99:	75 b5                	jne    80106e50 <allocuvm+0x40>
      cprintf("allocuvm out of memory\n");
80106e9b:	83 ec 0c             	sub    $0xc,%esp
80106e9e:	68 b5 81 10 80       	push   $0x801081b5
80106ea3:	e8 f8 97 ff ff       	call   801006a0 <cprintf>
  if(newsz >= oldsz)
80106ea8:	8b 45 0c             	mov    0xc(%ebp),%eax
80106eab:	83 c4 10             	add    $0x10,%esp
80106eae:	39 45 10             	cmp    %eax,0x10(%ebp)
80106eb1:	74 2d                	je     80106ee0 <allocuvm+0xd0>
80106eb3:	8b 55 10             	mov    0x10(%ebp),%edx
80106eb6:	89 c1                	mov    %eax,%ecx
80106eb8:	8b 45 08             	mov    0x8(%ebp),%eax
      return 0;
80106ebb:	31 ff                	xor    %edi,%edi
80106ebd:	e8 fe f9 ff ff       	call   801068c0 <deallocuvm.part.0>
}
...
80106f1b:	e8 a0 b5 ff ff       	call   801024c0 <kfree>
      return 0;
...
80106f50:	5d                   	pop    %ebp
80106f51:	e9 6a f9 ff ff       	jmp    801068c0 <deallocuvm.part.0>
...
80106f8b:	e8 30 f9 ff ff       	call   801068c0 <deallocuvm.part.0>
...
80106fdc:	68 e9 81 10 80       	push   $0x801081e9
...
80107010:	e8 5b d6 ff ff       	call   80104670 <memset>
80107015:	83 c4 10             	add    $0x10,%esp
                (uint)k->phys_start, k->perm) < 0) {
80107018:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
8010701b:	8b 53 08             	mov    0x8(%ebx),%edx
8010701e:	83 ec 0c             	sub    $0xc,%esp
80107021:	ff 73 0c             	push   0xc(%ebx)
80107024:	29 c2                	sub    %eax,%edx
80107026:	50                   	push   %eax
80107027:	52                   	push   %edx
80107028:	ff 33                	push   (%ebx)
8010702a:	56                   	push   %esi
8010702b:	e8 60 fa ff ff       	call   80106a90 <mappages>
80107030:	83 c4 20             	add    $0x20,%esp
...
8010707b:	a3 c4 95 11 80       	mov    %eax,0x801195c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
801070ac:	68 fa 81 10 80       	push   $0x801081fa
...
801070f3:	0f 84 c0 00 00 00    	je     801071b9 <copyuvm+0xd9>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
801070f9:	8b 55 0c             	mov    0xc(%ebp),%edx
801070fc:	85 d2                	test   %edx,%edx
801070fe:	0f 84 b5 00 00 00    	je     801071b9 <copyuvm+0xd9>
...
80107122:	68 04 82 10 80       	push   $0x80108204
...
80107149:	74 d4                	je     8010711f <copyuvm+0x3f>
    if(!(*pte & PTE_P))
8010714b:	8b 38                	mov    (%eax),%edi
8010714d:	f7 c7 01 00 00 00    	test   $0x1,%edi
80107153:	0f 84 9b 00 00 00    	je     801071f4 <copyuvm+0x114>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80107159:	89 fb                	mov    %edi,%ebx
    flags = PTE_FLAGS(*pte);
8010715b:	81 e7 ff 0f 00 00    	and    $0xfff,%edi
80107161:	89 7d e4             	mov    %edi,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80107164:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
    if((mem = kalloc()) == 0)
8010716a:	e8 11 b5 ff ff       	call   80102680 <kalloc>
8010716f:	89 c7                	mov    %eax,%edi
80107171:	85 c0                	test   %eax,%eax
80107173:	74 5f                	je     801071d4 <copyuvm+0xf4>
      goto bad;
    memmove(mem, (char*)P2V(pa), PGSIZE);
80107175:	83 ec 04             	sub    $0x4,%esp
80107178:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
8010717e:	68 00 10 00 00       	push   $0x1000
80107183:	53                   	push   %ebx
80107184:	50                   	push   %eax
80107185:	e8 86 d5 ff ff       	call   80104710 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
8010718a:	58                   	pop    %eax
8010718b:	8d 87 00 00 00 80    	lea    -0x80000000(%edi),%eax
80107191:	ff 75 e4             	push   -0x1c(%ebp)
80107194:	50                   	push   %eax
80107195:	68 00 10 00 00       	push   $0x1000
8010719a:	56                   	push   %esi
8010719b:	ff 75 e0             	push   -0x20(%ebp)
8010719e:	e8 ed f8 ff ff       	call   80106a90 <mappages>
801071a3:	83 c4 20             	add    $0x20,%esp
801071a6:	85 c0                	test   %eax,%eax
801071a8:	78 1e                	js     801071c8 <copyuvm+0xe8>
  for(i = 0; i < sz; i += PGSIZE){
801071aa:	81 c6 00 10 00 00    	add    $0x1000,%esi
801071b0:	39 75 0c             	cmp    %esi,0xc(%ebp)
801071b3:	0f 87 57 ff ff ff    	ja     80107110 <copyuvm+0x30>
  return d;
...
801071f7:	68 1e 82 10 80       	push   $0x8010821e
...
801072b0:	e8 5b d4 ff ff       	call   80104710 <memmove>
    len -= n;
    buf += n;
...
80107343:	83 ec 08             	sub    $0x8,%esp
	struct proc* curproc = myproc();
80107346:	e8 35 c6 ff ff       	call   80103980 <myproc>
	for (int i = 0; i < 16; i++) {
8010734b:	8d 90 80 00 00 00    	lea    0x80(%eax),%edx
80107351:	05 80 01 00 00       	add    $0x180,%eax
80107356:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010735d:	8d 76 00             	lea    0x0(%esi),%esi
		struct map_en* item = &(curproc->wmaps[i]);
		if (item->valid == 1) {
80107360:	83 3a 01             	cmpl   $0x1,(%edx)
80107363:	74 0b                	je     80107370 <check_valid+0x30>
	for (int i = 0; i < 16; i++) {
80107365:	83 c2 10             	add    $0x10,%edx
80107368:	39 c2                	cmp    %eax,%edx
8010736a:	75 f4                	jne    80107360 <check_valid+0x20>
				return -1;
			}
		}
	}
...
80107380 <count_allocated_pages>:
...
80107389:	8b 5d 10             	mov    0x10(%ebp),%ebx
8010738c:	8b 45 0c             	mov    0xc(%ebp),%eax
    int count = 0;
    uint va = addr;

    while (length > 0) {
8010738f:	85 db                	test   %ebx,%ebx
80107391:	7e 5d                	jle    801073f0 <count_allocated_pages+0x70>
80107393:	83 eb 01             	sub    $0x1,%ebx
80107396:	8d b8 00 10 00 00    	lea    0x1000(%eax),%edi
    int count = 0;
8010739c:	31 f6                	xor    %esi,%esi
8010739e:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
801073a4:	01 fb                	add    %edi,%ebx
801073a6:	eb 0e                	jmp    801073b6 <count_allocated_pages+0x36>
...
801073bf:	ff 70 04             	push   0x4(%eax)
801073c2:	e8 39 f6 ff ff       	call   80106a00 <walkpgdir>
        if (pte != 0 && (*pte & PTE_P) != 0) {
801073c7:	83 c4 10             	add    $0x10,%esp
801073ca:	85 c0                	test   %eax,%eax
801073cc:	74 0b                	je     801073d9 <count_allocated_pages+0x59>
801073ce:	8b 00                	mov    (%eax),%eax
801073d0:	83 e0 01             	and    $0x1,%eax
            count++;
801073d3:	83 f8 01             	cmp    $0x1,%eax
801073d6:	83 de ff             	sbb    $0xffffffff,%esi
        }
        va += PGSIZE;
801073d9:	89 f8                	mov    %edi,%eax
    while (length > 0) {
801073db:	39 df                	cmp    %ebx,%edi
801073dd:	75 d1                	jne    801073b0 <count_allocated_pages+0x30>
        length -= PGSIZE;
    }
...
80107404:	83 ec 14             	sub    $0x14,%esp
	struct proc *curproc = myproc();
80107407:	e8 74 c5 ff ff       	call   80103980 <myproc>
...
8010740c:	83 ec 04             	sub    $0x4,%esp
	struct proc *curproc = myproc();
8010740f:	89 c3                	mov    %eax,%ebx
    if (argptr(0, (char **)&wminfo, sizeof(struct wmapinfo)) < 0) {
80107411:	8d 45 f4             	lea    -0xc(%ebp),%eax
80107414:	68 c4 00 00 00       	push   $0xc4
80107419:	50                   	push   %eax
8010741a:	6a 00                	push   $0x0
8010741c:	e8 ef d5 ff ff       	call   80104a10 <argptr>
80107421:	83 c4 10             	add    $0x10,%esp
80107424:	85 c0                	test   %eax,%eax
80107426:	78 4a                	js     80107472 <getwmapinfo+0x72>
        // printf("get wmap info arg 0\n");
        return FAILED;
    }

    wminfo->total_mmaps = curproc->total_maps;
80107428:	8b 53 7c             	mov    0x7c(%ebx),%edx
8010742b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010742e:	89 10                	mov    %edx,(%eax)

	struct map_en* list = curproc->wmaps;

    // iterate
    for (int i = 0; i < 16; i++) {
80107430:	8b 4d f4             	mov    -0xc(%ebp),%ecx
80107433:	8d 83 80 00 00 00    	lea    0x80(%ebx),%eax
80107439:	8d 51 04             	lea    0x4(%ecx),%edx
8010743c:	8d 8b 80 01 00 00    	lea    0x180(%ebx),%ecx
80107442:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
		if (list[i].valid == 1) {
80107448:	83 38 01             	cmpl   $0x1,(%eax)
8010744b:	75 14                	jne    80107461 <getwmapinfo+0x61>
			wminfo->addr[i] = list[i].addr;
8010744d:	8b 58 04             	mov    0x4(%eax),%ebx
80107450:	89 1a                	mov    %ebx,(%edx)
			wminfo->length[i] = list[i].length;
80107452:	8b 58 08             	mov    0x8(%eax),%ebx
80107455:	89 5a 40             	mov    %ebx,0x40(%edx)
			wminfo->n_loaded_pages[i] = list[i].lpgs;
80107458:	8b 58 0c             	mov    0xc(%eax),%ebx
8010745b:	89 9a 80 00 00 00    	mov    %ebx,0x80(%edx)
    for (int i = 0; i < 16; i++) {
80107461:	83 c0 10             	add    $0x10,%eax
80107464:	83 c2 04             	add    $0x4,%edx
80107467:	39 c8                	cmp    %ecx,%eax
80107469:	75 dd                	jne    80107448 <getwmapinfo+0x48>
		}
    }
    return 0;
8010746b:	31 c0                	xor    %eax,%eax
}
8010746d:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80107470:	c9                   	leave  
80107471:	c3                   	ret    
        return FAILED;
80107472:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107477:	eb f4                	jmp    8010746d <getwmapinfo+0x6d>
80107479:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80107480 <getpgdirinfo>:
...
80107486:	83 ec 1c             	sub    $0x1c,%esp
    struct proc *curproc = myproc();
80107489:	e8 f2 c4 ff ff       	call   80103980 <myproc>
	struct pgdirinfo *pdinfo;

    if (argptr(0, (char **)&pdinfo, sizeof(struct pgdirinfo)) < 0) {
8010748e:	83 ec 04             	sub    $0x4,%esp
    struct proc *curproc = myproc();
80107491:	89 c3                	mov    %eax,%ebx
    if (argptr(0, (char **)&pdinfo, sizeof(struct pgdirinfo)) < 0) {
80107493:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80107496:	68 04 01 00 00       	push   $0x104
8010749b:	50                   	push   %eax
8010749c:	6a 00                	push   $0x0
8010749e:	e8 6d d5 ff ff       	call   80104a10 <argptr>
801074a3:	83 c4 10             	add    $0x10,%esp
801074a6:	85 c0                	test   %eax,%eax
801074a8:	0f 88 87 00 00 00    	js     80107535 <getpgdirinfo+0xb5>
        // printf("get pgdir info arg 0\n");
        return FAILED;
    }

    pdinfo->n_upages = 0;
801074ae:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801074b1:	c7 00 00 00 00 00    	movl   $0x0,(%eax)

    for (int i = 0; i < MAX_UPAGE_INFO; i++) {
        pdinfo->va[i] = 0;
801074b7:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801074ba:	8d 42 04             	lea    0x4(%edx),%eax
801074bd:	81 c2 84 00 00 00    	add    $0x84,%edx
801074c3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801074c7:	90                   	nop
801074c8:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    for (int i = 0; i < MAX_UPAGE_INFO; i++) {
801074ce:	83 c0 04             	add    $0x4,%eax
        pdinfo->pa[i] = 0;
801074d1:	c7 40 7c 00 00 00 00 	movl   $0x0,0x7c(%eax)
    for (int i = 0; i < MAX_UPAGE_INFO; i++) {
801074d8:	39 d0                	cmp    %edx,%eax
801074da:	75 ec                	jne    801074c8 <getpgdirinfo+0x48>
    }

    pde_t *pgdir = curproc->pgdir;
801074dc:	8b 73 04             	mov    0x4(%ebx),%esi
    uint va = 0;
801074df:	31 ff                	xor    %edi,%edi
    int i = 0;
801074e1:	31 db                	xor    %ebx,%ebx
...
801074ed:	57                   	push   %edi
801074ee:	56                   	push   %esi
801074ef:	e8 0c f5 ff ff       	call   80106a00 <walkpgdir>

        if (pte != 0 && (*pte & PTE_P) != 0 && (*pte & PTE_U) != 0) {
801074f4:	83 c4 10             	add    $0x10,%esp
801074f7:	85 c0                	test   %eax,%eax
801074f9:	74 25                	je     80107520 <getpgdirinfo+0xa0>
801074fb:	8b 10                	mov    (%eax),%edx
801074fd:	83 e2 05             	and    $0x5,%edx
80107500:	83 fa 05             	cmp    $0x5,%edx
80107503:	75 1b                	jne    80107520 <getpgdirinfo+0xa0>
            pdinfo->va[i] = va;
80107505:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80107508:	89 7c 9a 04          	mov    %edi,0x4(%edx,%ebx,4)
            pdinfo->pa[i] = PTE_ADDR(*pte);
8010750c:	8b 00                	mov    (%eax),%eax
8010750e:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107513:	89 84 9a 84 00 00 00 	mov    %eax,0x84(%edx,%ebx,4)
            pdinfo->n_upages++;
            i++;
8010751a:	83 c3 01             	add    $0x1,%ebx
            pdinfo->n_upages++;
8010751d:	83 02 01             	addl   $0x1,(%edx)
        }

        va += PGSIZE;
80107520:	81 c7 00 10 00 00    	add    $0x1000,%edi
    while (i < MAX_UPAGE_INFO) {
80107526:	83 fb 20             	cmp    $0x20,%ebx
80107529:	75 bd                	jne    801074e8 <getpgdirinfo+0x68>
    }
...
80107534:	c3                   	ret    
        return FAILED;
80107535:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010753a:	eb f1                	jmp    8010752d <getpgdirinfo+0xad>
...
80107545:	83 ec 10             	sub    $0x10,%esp
    struct proc *curproc = myproc();
80107548:	e8 33 c4 ff ff       	call   80103980 <myproc>
	/* INPUTS */
	uint addr;
	int length, flags, fd;
...
80107558:	e8 63 d4 ff ff       	call   801049c0 <arguint>
8010755d:	83 c4 10             	add    $0x10,%esp
80107560:	85 c0                	test   %eax,%eax
80107562:	0f 88 28 01 00 00    	js     80107690 <wmap+0x150>
        argint(1, &length) < 0 ||  // Second argument
80107568:	83 ec 08             	sub    $0x8,%esp
8010756b:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010756e:	50                   	push   %eax
8010756f:	6a 01                	push   $0x1
80107571:	e8 fa d3 ff ff       	call   80104970 <argint>
    if (arguint(0, &addr) < 0 ||    // First argument
80107576:	83 c4 10             	add    $0x10,%esp
80107579:	85 c0                	test   %eax,%eax
8010757b:	0f 88 0f 01 00 00    	js     80107690 <wmap+0x150>
        argint(2, &flags) < 0 ||   // Third argument
80107581:	83 ec 08             	sub    $0x8,%esp
80107584:	8d 45 f0             	lea    -0x10(%ebp),%eax
80107587:	50                   	push   %eax
80107588:	6a 02                	push   $0x2
8010758a:	e8 e1 d3 ff ff       	call   80104970 <argint>
        argint(1, &length) < 0 ||  // Second argument
8010758f:	83 c4 10             	add    $0x10,%esp
80107592:	85 c0                	test   %eax,%eax
80107594:	0f 88 f6 00 00 00    	js     80107690 <wmap+0x150>
        argint(3, &fd) < 0)        // Fourth argument
8010759a:	83 ec 08             	sub    $0x8,%esp
8010759d:	8d 45 f4             	lea    -0xc(%ebp),%eax
801075a0:	50                   	push   %eax
801075a1:	6a 03                	push   $0x3
801075a3:	e8 c8 d3 ff ff       	call   80104970 <argint>
        argint(2, &flags) < 0 ||   // Third argument
801075a8:	83 c4 10             	add    $0x10,%esp
801075ab:	85 c0                	test   %eax,%eax
801075ad:	0f 88 dd 00 00 00    	js     80107690 <wmap+0x150>
	...
	// check length
	if ((uint)length <= 0) {
801075b3:	8b 45 ec             	mov    -0x14(%ebp),%eax
        return PGSIZE;
801075b6:	be 00 10 00 00       	mov    $0x1000,%esi
	if ((uint)length <= 0) {
801075bb:	85 c0                	test   %eax,%eax
801075bd:	0f 84 d2 00 00 00    	je     80107695 <wmap+0x155>
		//return FAILED;
    }

	// check flags
    if ((flags & MAP_SHARED) && (flags & MAP_PRIVATE)) {
801075c3:	8b 55 f0             	mov    -0x10(%ebp),%edx
801075c6:	89 d1                	mov    %edx,%ecx
801075c8:	83 e1 03             	and    $0x3,%ecx
801075cb:	83 f9 03             	cmp    $0x3,%ecx
801075ce:	0f 84 0c 01 00 00    	je     801076e0 <wmap+0x1a0>
    }
	...
	// MAP_FIXED flag
    if (flags & MAP_FIXED) {
801075d4:	83 e2 08             	and    $0x8,%edx
801075d7:	0f 84 c3 00 00 00    	je     801076a0 <wmap+0x160>
        if (addr < USERBOUNDARY || addr >= KERNBASE || addr % PGSIZE != 0) {
801075dd:	8b 45 e8             	mov    -0x18(%ebp),%eax
            return -3;
801075e0:	be fd ff ff ff       	mov    $0xfffffffd,%esi
        if (addr < USERBOUNDARY || addr >= KERNBASE || addr % PGSIZE != 0) {
801075e5:	8d 90 00 00 00 a0    	lea    -0x60000000(%eax),%edx
801075eb:	81 fa ff ff ff 1f    	cmp    $0x1fffffff,%edx
801075f1:	0f 87 9e 00 00 00    	ja     80107695 <wmap+0x155>
801075f7:	a9 ff 0f 00 00       	test   $0xfff,%eax
801075fc:	0f 85 93 00 00 00    	jne    80107695 <wmap+0x155>
	struct proc* curproc = myproc();
80107602:	e8 79 c3 ff ff       	call   80103980 <myproc>
	for (int i = 0; i < 16; i++) {
80107607:	8d 90 80 00 00 00    	lea    0x80(%eax),%edx
8010760d:	05 80 01 00 00       	add    $0x180,%eax
80107612:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
		if (item->valid == 1) {
80107618:	83 3a 01             	cmpl   $0x1,(%edx)
8010761b:	74 73                	je     80107690 <wmap+0x150>
	for (int i = 0; i < 16; i++) {
8010761d:	83 c2 10             	add    $0x10,%edx
80107620:	39 c2                	cmp    %eax,%edx
80107622:	75 f4                	jne    80107618 <wmap+0xd8>
		...
		va = addr;
80107624:	8b 75 e8             	mov    -0x18(%ebp),%esi
			return -7;
	}
...
80107627:	f6 45 f0 04          	testb  $0x4,-0x10(%ebp)
8010762b:	75 22                	jne    8010764f <wmap+0x10f>
        // do nothing
    } else {
		if (fd <= 0)
8010762d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107630:	85 c0                	test   %eax,%eax
80107632:	0f 8e af 00 00 00    	jle    801076e7 <wmap+0x1a7>
		{
			return -5;
		}
...
8010763b:	ff 74 83 28          	push   0x28(%ebx,%eax,4)
8010763f:	e8 5c 98 ff ff       	call   80100ea0 <filedup>
		if (f == 0)
80107644:	83 c4 10             	add    $0x10,%esp
80107647:	85 c0                	test   %eax,%eax
80107649:	0f 84 9f 00 00 00    	je     801076ee <wmap+0x1ae>
	...
	for (int i = 0; i < 16; i++)
8010764f:	8d 83 80 00 00 00    	lea    0x80(%ebx),%eax
80107655:	8d 93 80 01 00 00    	lea    0x180(%ebx),%edx
8010765b:	eb 0a                	jmp    80107667 <wmap+0x127>
8010765d:	8d 76 00             	lea    0x0(%esi),%esi
80107660:	83 c0 10             	add    $0x10,%eax
80107663:	39 c2                	cmp    %eax,%edx
80107665:	74 2e                	je     80107695 <wmap+0x155>
    {
        if (cme[i].valid == 0)
80107667:	8b 08                	mov    (%eax),%ecx
80107669:	85 c9                	test   %ecx,%ecx
8010766b:	75 f3                	jne    80107660 <wmap+0x120>
        {
            // place it here
            cme[i].valid = 1;
8010766d:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
			cme[i].addr = va;
			cme[i].length = length;
80107673:	8b 55 ec             	mov    -0x14(%ebp),%edx
			cme[i].addr = va;
80107676:	89 70 04             	mov    %esi,0x4(%eax)
			cme[i].length = length;
80107679:	89 50 08             	mov    %edx,0x8(%eax)
			cme[i].lpgs = 0;
8010767c:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
			curproc->total_maps++;
80107683:	83 43 7c 01          	addl   $0x1,0x7c(%ebx)
			break;
80107687:	eb 0c                	jmp    80107695 <wmap+0x155>
80107689:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        return -1; // Error handling: Return an error code
80107690:	be ff ff ff ff       	mov    $0xffffffff,%esi
        }
    }	

    return va;
}
80107695:	8d 65 f8             	lea    -0x8(%ebp),%esp
80107698:	89 f0                	mov    %esi,%eax
8010769a:	5b                   	pop    %ebx
8010769b:	5e                   	pop    %esi
8010769c:	5d                   	pop    %ebp
8010769d:	c3                   	ret    
...
801076a0:	83 7b 7c 0f          	cmpl   $0xf,0x7c(%ebx)
801076a4:	7f ea                	jg     80107690 <wmap+0x150>
			return -7;
801076a6:	be f9 ff ff ff       	mov    $0xfffffff9,%esi
		while(t_va + length < KERNBASE) {
801076ab:	3d 00 00 00 a0       	cmp    $0xa0000000,%eax
801076b0:	7c e3                	jl     80107695 <wmap+0x155>
	struct proc* curproc = myproc();
801076b2:	e8 c9 c2 ff ff       	call   80103980 <myproc>
	for (int i = 0; i < 16; i++) {
801076b7:	8d 90 80 00 00 00    	lea    0x80(%eax),%edx
801076bd:	05 80 01 00 00       	add    $0x180,%eax
801076c2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
		if (item->valid == 1) {
801076c8:	83 3a 01             	cmpl   $0x1,(%edx)
801076cb:	74 07                	je     801076d4 <wmap+0x194>
	for (int i = 0; i < 16; i++) {
801076cd:	83 c2 10             	add    $0x10,%edx
801076d0:	39 c2                	cmp    %eax,%edx
801076d2:	75 f4                	jne    801076c8 <wmap+0x188>
			return valid;
801076d4:	31 f6                	xor    %esi,%esi
801076d6:	eb bd                	jmp    80107695 <wmap+0x155>
801076d8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801076df:	90                   	nop
        return -2;
801076e0:	be fe ff ff ff       	mov    $0xfffffffe,%esi
801076e5:	eb ae                	jmp    80107695 <wmap+0x155>
			return -5;
801076e7:	be fb ff ff ff       	mov    $0xfffffffb,%esi
801076ec:	eb a7                	jmp    80107695 <wmap+0x155>
			return -6;
801076ee:	be fa ff ff ff       	mov    $0xfffffffa,%esi
801076f3:	eb a0                	jmp    80107695 <wmap+0x155>
...
80107705:	83 ec 10             	sub    $0x10,%esp
    struct proc *curproc = myproc();
80107708:	e8 73 c2 ff ff       	call   80103980 <myproc>
    uint addr;
    if (arguint(0, &addr) < 0) {
8010770d:	83 ec 08             	sub    $0x8,%esp
    struct proc *curproc = myproc();
80107710:	89 c6                	mov    %eax,%esi
    if (arguint(0, &addr) < 0) {
80107712:	8d 45 f4             	lea    -0xc(%ebp),%eax
80107715:	50                   	push   %eax
80107716:	6a 00                	push   $0x0
80107718:	e8 a3 d2 ff ff       	call   801049c0 <arguint>
8010771d:	83 c4 10             	add    $0x10,%esp
80107720:	85 c0                	test   %eax,%eax
80107722:	0f 88 97 00 00 00    	js     801077bf <wunmap+0xbf>
        return -1;
    }
	/* CATCH ERROR */
	if (addr % PGSIZE != 0)
80107728:	8b 5d f4             	mov    -0xc(%ebp),%ebx
8010772b:	f7 c3 ff 0f 00 00    	test   $0xfff,%ebx
80107731:	0f 85 88 00 00 00    	jne    801077bf <wunmap+0xbf>
	int free_len = 0;
    free_len ++;
    free_len --;
    struct map_en* list = curproc->wmaps;
    ...
    for (int i = 0; i < 16; i++) {
80107737:	8d 86 80 00 00 00    	lea    0x80(%esi),%eax
8010773d:	8d 96 80 01 00 00    	lea    0x180(%esi),%edx
80107743:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80107747:	90                   	nop
        if (list[i].addr == addr) {
80107748:	3b 58 04             	cmp    0x4(%eax),%ebx
8010774b:	74 63                	je     801077b0 <wunmap+0xb0>
    for (int i = 0; i < 16; i++) {
8010774d:	83 c0 10             	add    $0x10,%eax
80107750:	39 d0                	cmp    %edx,%eax
80107752:	75 f4                	jne    80107748 <wunmap+0x48>
            break;
        }
    }
...
80107754:	e8 27 c2 ff ff       	call   80103980 <myproc>
80107759:	83 ec 04             	sub    $0x4,%esp
    ...
    */
	...
	return SUCCESS;
8010775c:	31 f6                	xor    %esi,%esi
    pte_t *pte = walkpgdir(myproc()->pgdir, (void *)addr, 0);
8010775e:	6a 00                	push   $0x0
80107760:	53                   	push   %ebx
80107761:	ff 70 04             	push   0x4(%eax)
80107764:	e8 97 f2 ff ff       	call   80106a00 <walkpgdir>
    if (pte != 0 && (*pte & PTE_P)) {
80107769:	83 c4 10             	add    $0x10,%esp
    pte_t *pte = walkpgdir(myproc()->pgdir, (void *)addr, 0);
8010776c:	89 c3                	mov    %eax,%ebx
    if (pte != 0 && (*pte & PTE_P)) {
8010776e:	85 c0                	test   %eax,%eax
80107770:	74 06                	je     80107778 <wunmap+0x78>
80107772:	8b 00                	mov    (%eax),%eax
80107774:	a8 01                	test   $0x1,%al
80107776:	75 10                	jne    80107788 <wunmap+0x88>
}
80107778:	8d 65 f8             	lea    -0x8(%ebp),%esp
8010777b:	89 f0                	mov    %esi,%eax
8010777d:	5b                   	pop    %ebx
8010777e:	5e                   	pop    %esi
8010777f:	5d                   	pop    %ebp
80107780:	c3                   	ret    
...
80107796:	e8 25 ad ff ff       	call   801024c0 <kfree>
        *pte = 0;
8010779b:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
801077a1:	83 c4 10             	add    $0x10,%esp
}
801077a4:	89 f0                	mov    %esi,%eax
...
801077b0:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    pte_t *pte = walkpgdir(myproc()->pgdir, (void *)addr, 0);
801077b6:	8b 5d f4             	mov    -0xc(%ebp),%ebx
            curproc->total_maps--;
801077b9:	83 6e 7c 01          	subl   $0x1,0x7c(%esi)
            break;
801077bd:	eb 95                	jmp    80107754 <wunmap+0x54>
        return -1;
801077bf:	be ff ff ff ff       	mov    $0xffffffff,%esi
801077c4:	eb b2                	jmp    80107778 <wunmap+0x78>
